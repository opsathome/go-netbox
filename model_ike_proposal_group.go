...
type IKEProposalGroup struct {
	Value                *BulkIKEProposalRequestGroup `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkIKEProposalRequestGroup and assigns it to the Value field.
