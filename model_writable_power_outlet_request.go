...
// WritablePowerOutletRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *WritablePowerOutletRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *WritablePowerOutletRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *WritablePowerOutletRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *WritablePowerOutletRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
