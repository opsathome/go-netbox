...
func (o *FrontPortTemplateRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *FrontPortTemplateRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *FrontPortTemplateRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
