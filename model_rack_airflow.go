...
type RackAirflow struct {
	Value                *BulkRackRequestAirflow `json:"value,omitempty"`
...
func (o *RackAirflow) GetValue() BulkRackRequestAirflow {
...
func (o *RackAirflow) GetValueOk() (*BulkRackRequestAirflow, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkRackRequestAirflow and assigns it to the Value field.
func (o *RackAirflow) SetValue(v BulkRackRequestAirflow) {
	o.Value = &v
}
