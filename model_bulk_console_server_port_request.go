...
// checks if the BulkConsoleServerPortRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkConsoleServerPortRequest{}

// BulkConsoleServerPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkConsoleServerPortRequest struct {
	Id     int32                                `json:"id"`
...
type _BulkConsoleServerPortRequest BulkConsoleServerPortRequest
...
func NewBulkConsoleServerPortRequest(id int32, device BriefInterfaceRequestDevice, name string) *BulkConsoleServerPortRequest {
	this := BulkConsoleServerPortRequest{}
	this.Id = id
	this.Device = device
	this.Name = name
	return &this
...
func (o *BulkConsoleServerPortRequest) GetDevice() BriefInterfaceRequestDevice {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkConsoleServerPortRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkConsoleServerPortRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = v
}
...
func (o *BulkConsoleServerPortRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *BulkConsoleServerPortRequest) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
func (o *BulkConsoleServerPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkConsoleServerPortRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkConsoleServerPortRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkConsoleServerPortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkConsoleServerPortRequest := _BulkConsoleServerPortRequest{}

	err = json.Unmarshal(data, &varBulkConsoleServerPortRequest)

	if err != nil {
		return err
	}

	*o = BulkConsoleServerPortRequest(varBulkConsoleServerPortRequest)
...
type NullableBulkConsoleServerPortRequest struct {
	value *BulkConsoleServerPortRequest
	isSet bool
}

func (v NullableBulkConsoleServerPortRequest) Get() *BulkConsoleServerPortRequest {
	return v.value
}

func (v *NullableBulkConsoleServerPortRequest) Set(val *BulkConsoleServerPortRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkConsoleServerPortRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkConsoleServerPortRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkConsoleServerPortRequest(val *BulkConsoleServerPortRequest) *NullableBulkConsoleServerPortRequest {
	return &NullableBulkConsoleServerPortRequest{value: val, isSet: true}
}

func (v NullableBulkConsoleServerPortRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkConsoleServerPortRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
