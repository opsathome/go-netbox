...
// checks if the BulkIKEPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkIKEPolicyRequest{}

// BulkIKEPolicyRequest Base serializer class for models inheriting from PrimaryModel.
type BulkIKEPolicyRequest struct {
	Id                   int32                        `json:"id"`
	Name                 string                       `json:"name"`
	Description          *string                      `json:"description,omitempty"`
	Version              BulkIKEPolicyRequestVersion  `json:"version"`
...
type _BulkIKEPolicyRequest BulkIKEPolicyRequest
...
func (o *BulkIKEPolicyRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkIKEPolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkIKEPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkIKEPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkIKEPolicyRequest := _BulkIKEPolicyRequest{}

	err = json.Unmarshal(data, &varBulkIKEPolicyRequest)

	if err != nil {
		return err
	}

	*o = BulkIKEPolicyRequest(varBulkIKEPolicyRequest)
...
type NullableBulkIKEPolicyRequest struct {
	value *BulkIKEPolicyRequest
	isSet bool
}

func (v NullableBulkIKEPolicyRequest) Get() *BulkIKEPolicyRequest {
	return v.value
}

func (v *NullableBulkIKEPolicyRequest) Set(val *BulkIKEPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkIKEPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkIKEPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkIKEPolicyRequest(val *BulkIKEPolicyRequest) *NullableBulkIKEPolicyRequest {
	return &NullableBulkIKEPolicyRequest{value: val, isSet: true}
}

func (v NullableBulkIKEPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkIKEPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
