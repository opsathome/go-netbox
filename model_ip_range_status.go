...
type IPRangeStatus struct {
	Value                *BulkIPRangeRequestStatus `json:"value,omitempty"`
...
func (o *IPRangeStatus) GetValue() BulkIPRangeRequestStatus {
...
func (o *IPRangeStatus) GetValueOk() (*BulkIPRangeRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkIPRangeRequestStatus and assigns it to the Value field.
func (o *IPRangeStatus) SetValue(v BulkIPRangeRequestStatus) {
	o.Value = &v
}
