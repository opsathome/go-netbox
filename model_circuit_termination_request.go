...
func NewCircuitTerminationRequest(circuit BulkCircuitTerminationRequestCircuit, termSide TerminationSide1) *CircuitTerminationRequest {
...
func (o *CircuitTerminationRequest) GetCircuit() BulkCircuitTerminationRequestCircuit {
	if o == nil {
...
func (o *CircuitTerminationRequest) GetCircuitOk() (*BulkCircuitTerminationRequestCircuit, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CircuitTerminationRequest) SetCircuit(v BulkCircuitTerminationRequestCircuit) {
	o.Circuit = v
}
