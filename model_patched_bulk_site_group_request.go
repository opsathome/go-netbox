...
// checks if the PatchedBulkSiteGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkSiteGroupRequest{}

// PatchedBulkSiteGroupRequest Base serializer class for models inheriting from NestedGroupModel.
type PatchedBulkSiteGroupRequest struct {
	Id                   int32                          `json:"id"`
...
type _PatchedBulkSiteGroupRequest PatchedBulkSiteGroupRequest
...
func NewPatchedBulkSiteGroupRequest(id int32) *PatchedBulkSiteGroupRequest {
	this := PatchedBulkSiteGroupRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkSiteGroupRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *PatchedBulkSiteGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkSiteGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkSiteGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkSiteGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkSiteGroupRequest := _PatchedBulkSiteGroupRequest{}

	err = json.Unmarshal(data, &varPatchedBulkSiteGroupRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkSiteGroupRequest(varPatchedBulkSiteGroupRequest)
...
type NullablePatchedBulkSiteGroupRequest struct {
	value *PatchedBulkSiteGroupRequest
	isSet bool
}

func (v NullablePatchedBulkSiteGroupRequest) Get() *PatchedBulkSiteGroupRequest {
	return v.value
}

func (v *NullablePatchedBulkSiteGroupRequest) Set(val *PatchedBulkSiteGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkSiteGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkSiteGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkSiteGroupRequest(val *PatchedBulkSiteGroupRequest) *NullablePatchedBulkSiteGroupRequest {
	return &NullablePatchedBulkSiteGroupRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkSiteGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkSiteGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
