...
type TunnelTerminationRole struct {
	Value                *BulkTunnelTerminationRequestRole `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkTunnelTerminationRequestRole and assigns it to the Value field.
