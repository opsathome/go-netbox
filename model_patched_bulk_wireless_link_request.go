...
// checks if the PatchedBulkWirelessLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWirelessLinkRequest{}

// PatchedBulkWirelessLinkRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkWirelessLinkRequest struct {
	Id                   int32                                          `json:"id"`
	InterfaceA           *BulkVirtualCircuitTerminationRequestInterface `json:"interface_a,omitempty"`
	InterfaceB           *BulkVirtualCircuitTerminationRequestInterface `json:"interface_b,omitempty"`
...
type _PatchedBulkWirelessLinkRequest PatchedBulkWirelessLinkRequest
...
func NewPatchedBulkWirelessLinkRequest(id int32) *PatchedBulkWirelessLinkRequest {
	this := PatchedBulkWirelessLinkRequest{}
	this.Id = id
	return &this
}
...
// SetInterfaceA gets a reference to the given BulkVirtualCircuitTerminationRequestInterface and assigns it to the InterfaceA field.
...
// SetInterfaceB gets a reference to the given BulkVirtualCircuitTerminationRequestInterface and assigns it to the InterfaceB field.
...
func (o *PatchedBulkWirelessLinkRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkWirelessLinkRequest) SetDistanceNil() {
	o.Distance.Set(nil)
}
...
func (o *PatchedBulkWirelessLinkRequest) SetDistanceUnitNil() {
...
func (o *PatchedBulkWirelessLinkRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkWirelessLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWirelessLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWirelessLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWirelessLinkRequest := _PatchedBulkWirelessLinkRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWirelessLinkRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWirelessLinkRequest(varPatchedBulkWirelessLinkRequest)
...
type NullablePatchedBulkWirelessLinkRequest struct {
	value *PatchedBulkWirelessLinkRequest
	isSet bool
}

func (v NullablePatchedBulkWirelessLinkRequest) Get() *PatchedBulkWirelessLinkRequest {
	return v.value
}

func (v *NullablePatchedBulkWirelessLinkRequest) Set(val *PatchedBulkWirelessLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWirelessLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWirelessLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWirelessLinkRequest(val *PatchedBulkWirelessLinkRequest) *NullablePatchedBulkWirelessLinkRequest {
	return &NullablePatchedBulkWirelessLinkRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWirelessLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWirelessLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
