...
// checks if the PatchedBulkPrefixRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkPrefixRequest{}

// PatchedBulkPrefixRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkPrefixRequest struct {
	Id        int32                                    `json:"id"`
	...
	Status    *BulkPrefixRequestStatus                 `json:"status,omitempty"`
...
type _PatchedBulkPrefixRequest PatchedBulkPrefixRequest
...
func (o *PatchedBulkPrefixRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) SetScopeTypeNil() {
	o.ScopeType.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) SetScopeIdNil() {
	o.ScopeId.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) SetVlanNil() {
	o.Vlan.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) GetStatus() BulkPrefixRequestStatus {
	if o == nil || IsNil(o.Status) {
		var ret BulkPrefixRequestStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given BulkPrefixRequestStatus and assigns it to the Status field.
...
func (o *PatchedBulkPrefixRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *PatchedBulkPrefixRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkPrefixRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkPrefixRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkPrefixRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkPrefixRequest := _PatchedBulkPrefixRequest{}

	err = json.Unmarshal(data, &varPatchedBulkPrefixRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkPrefixRequest(varPatchedBulkPrefixRequest)
...
type NullablePatchedBulkPrefixRequest struct {
	value *PatchedBulkPrefixRequest
	isSet bool
}

func (v NullablePatchedBulkPrefixRequest) Get() *PatchedBulkPrefixRequest {
	return v.value
}

func (v *NullablePatchedBulkPrefixRequest) Set(val *PatchedBulkPrefixRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkPrefixRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkPrefixRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkPrefixRequest(val *PatchedBulkPrefixRequest) *NullablePatchedBulkPrefixRequest {
	return &NullablePatchedBulkPrefixRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkPrefixRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkPrefixRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
