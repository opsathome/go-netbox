...
type WirelessLANStatus struct {
	Value                *BulkWirelessLANRequestStatus `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkWirelessLANRequestStatus and assigns it to the Value field.
