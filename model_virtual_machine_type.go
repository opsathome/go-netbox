...
// checks if the VirtualMachineType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualMachineType{}

// VirtualMachineType Base serializer class for models inheriting from PrimaryModel.
...
type _VirtualMachineType VirtualMachineType
...
func (o *VirtualMachineType) SetDefaultPlatformNil() {
...
func (o *VirtualMachineType) SetDefaultVcpusNil() {
...
func (o *VirtualMachineType) SetDefaultMemoryNil() {
...
func (o *VirtualMachineType) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *VirtualMachineType) SetCreatedNil() {
	o.Created.Set(nil)
}
...
func (o *VirtualMachineType) SetLastUpdatedNil() {
...
func (o VirtualMachineType) MarshalJSON() ([]byte, error) {
...
func (o VirtualMachineType) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualMachineType) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualMachineType := _VirtualMachineType{}

	err = json.Unmarshal(data, &varVirtualMachineType)

	if err != nil {
		return err
	}

	*o = VirtualMachineType(varVirtualMachineType)
...
type NullableVirtualMachineType struct {
	value *VirtualMachineType
	isSet bool
}

func (v NullableVirtualMachineType) Get() *VirtualMachineType {
	return v.value
}

func (v *NullableVirtualMachineType) Set(val *VirtualMachineType) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualMachineType) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualMachineType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualMachineType(val *VirtualMachineType) *NullableVirtualMachineType {
	return &NullableVirtualMachineType{value: val, isSet: true}
}

func (v NullableVirtualMachineType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualMachineType) UnmarshalJSON(src []byte) error {
	v.isSet = true
