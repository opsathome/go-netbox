...
// checks if the BulkDeviceTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkDeviceTypeRequest{}

// BulkDeviceTypeRequest Base serializer class for models inheriting from PrimaryModel.
type BulkDeviceTypeRequest struct {
	Id              int32                                        `json:"id"`
...
type _BulkDeviceTypeRequest BulkDeviceTypeRequest
...
func (o *BulkDeviceTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *BulkDeviceTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkDeviceTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
	o.DefaultPlatform.Set(&v)
}

// SetDefaultPlatformNil sets the value for DefaultPlatform to be an explicit nil
func (o *BulkDeviceTypeRequest) SetDefaultPlatformNil() {
...
func (o *BulkDeviceTypeRequest) SetSubdeviceRoleNil() {
...
func (o *BulkDeviceTypeRequest) SetAirflowNil() {
	o.Airflow.Set(nil)
}
...
func (o *BulkDeviceTypeRequest) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o *BulkDeviceTypeRequest) SetWeightUnitNil() {
...
func (o *BulkDeviceTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkDeviceTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkDeviceTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkDeviceTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkDeviceTypeRequest := _BulkDeviceTypeRequest{}

	err = json.Unmarshal(data, &varBulkDeviceTypeRequest)

	if err != nil {
		return err
	}

	*o = BulkDeviceTypeRequest(varBulkDeviceTypeRequest)
...
type NullableBulkDeviceTypeRequest struct {
	value *BulkDeviceTypeRequest
	isSet bool
}

func (v NullableBulkDeviceTypeRequest) Get() *BulkDeviceTypeRequest {
	return v.value
}

func (v *NullableBulkDeviceTypeRequest) Set(val *BulkDeviceTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkDeviceTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkDeviceTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkDeviceTypeRequest(val *BulkDeviceTypeRequest) *NullableBulkDeviceTypeRequest {
	return &NullableBulkDeviceTypeRequest{value: val, isSet: true}
}

func (v NullableBulkDeviceTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkDeviceTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
