...
func (o *FrontPortTemplate) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *FrontPortTemplate) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *FrontPortTemplate) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *FrontPortTemplate) GetRearPorts() []FrontPortTemplateMapping {
	if o == nil || IsNil(o.RearPorts) {
		var ret []FrontPortTemplateMapping
		return ret
	}
	return o.RearPorts
}
...
// SetRearPorts gets a reference to the given []FrontPortTemplateMapping and assigns it to the RearPorts field.
