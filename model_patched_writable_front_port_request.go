...
func (o *PatchedWritableFrontPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableFrontPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedWritableFrontPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
