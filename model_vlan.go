...
// VLAN Base serializer class for models inheriting from PrimaryModel.
type VLAN struct {
	Id         int32                  `json:"id"`
	Url        string                 `json:"url"`
	...
	QinqRole             NullableVLANQinqRole          `json:"qinq_role,omitempty"`
...
// SetQinqRole gets a reference to the given NullableVLANQinqRole and assigns it to the QinqRole field.
func (o *VLAN) SetQinqRole(v VLANQinqRole) {
	o.QinqRole.Set(&v)
}

// SetQinqRoleNil sets the value for QinqRole to be an explicit nil
func (o *VLAN) SetQinqRoleNil() {
	o.QinqRole.Set(nil)
}
