...
// VirtualCircuitTypeRequest Base serializer class for models inheriting from OrganizationalModel.
...
func (o *VirtualCircuitTypeRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *VirtualCircuitTypeRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *VirtualCircuitTypeRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *VirtualCircuitTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
