...
// checks if the BulkConfigContextRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkConfigContextRequest{}

// BulkConfigContextRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkConfigContextRequest struct {
	Id                   int32                                      `json:"id"`
...
type _BulkConfigContextRequest BulkConfigContextRequest
...
func (o *BulkConfigContextRequest) SetProfileNil() {
	o.Profile.Set(nil)
}
...
func (o *BulkConfigContextRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkConfigContextRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkConfigContextRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkConfigContextRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkConfigContextRequest := _BulkConfigContextRequest{}

	err = json.Unmarshal(data, &varBulkConfigContextRequest)

	if err != nil {
		return err
	}

	*o = BulkConfigContextRequest(varBulkConfigContextRequest)
...
type NullableBulkConfigContextRequest struct {
	value *BulkConfigContextRequest
	isSet bool
}

func (v NullableBulkConfigContextRequest) Get() *BulkConfigContextRequest {
	return v.value
}

func (v *NullableBulkConfigContextRequest) Set(val *BulkConfigContextRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkConfigContextRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkConfigContextRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkConfigContextRequest(val *BulkConfigContextRequest) *NullableBulkConfigContextRequest {
	return &NullableBulkConfigContextRequest{value: val, isSet: true}
}

func (v NullableBulkConfigContextRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkConfigContextRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
