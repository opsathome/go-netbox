...
// checks if the VirtualMachineTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualMachineTypeRequest{}

// VirtualMachineTypeRequest Base serializer class for models inheriting from PrimaryModel.
type VirtualMachineTypeRequest struct {
...
type _VirtualMachineTypeRequest VirtualMachineTypeRequest
...
func NewVirtualMachineTypeRequest(name string, slug string) *VirtualMachineTypeRequest {
	this := VirtualMachineTypeRequest{}
	this.Name = name
	this.Slug = slug
	return &this
}
...
func (o *VirtualMachineTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *VirtualMachineTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualMachineTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
	o.DefaultPlatform.Set(&v)
}

// SetDefaultPlatformNil sets the value for DefaultPlatform to be an explicit nil
func (o *VirtualMachineTypeRequest) SetDefaultPlatformNil() {
...
func (o *VirtualMachineTypeRequest) SetDefaultVcpusNil() {
...
func (o *VirtualMachineTypeRequest) SetDefaultMemoryNil() {
...
func (o *VirtualMachineTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o VirtualMachineTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o VirtualMachineTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualMachineTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualMachineTypeRequest := _VirtualMachineTypeRequest{}

	err = json.Unmarshal(data, &varVirtualMachineTypeRequest)

	if err != nil {
		return err
	}

	*o = VirtualMachineTypeRequest(varVirtualMachineTypeRequest)
...
type NullableVirtualMachineTypeRequest struct {
	value *VirtualMachineTypeRequest
	isSet bool
}

func (v NullableVirtualMachineTypeRequest) Get() *VirtualMachineTypeRequest {
	return v.value
}

func (v *NullableVirtualMachineTypeRequest) Set(val *VirtualMachineTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualMachineTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualMachineTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualMachineTypeRequest(val *VirtualMachineTypeRequest) *NullableVirtualMachineTypeRequest {
	return &NullableVirtualMachineTypeRequest{value: val, isSet: true}
}

func (v NullableVirtualMachineTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualMachineTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
