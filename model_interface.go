...
// Interface Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
// GetBridgeInterfaces returns the BridgeInterfaces field value
func (o *Interface) GetBridgeInterfaces() []NestedInterface {
	...
	return o.BridgeInterfaces
}

// GetBridgeInterfacesOk returns a tuple with the BridgeInterfaces field value
// and a boolean to check if the value has been set.
func (o *Interface) GetBridgeInterfacesOk() ([]NestedInterface, bool) {
	if o == nil {
		return nil, false
	}
	return o.BridgeInterfaces, true
}

// SetBridgeInterfaces sets field value
func (o *Interface) SetBridgeInterfaces(v []NestedInterface) {
	o.BridgeInterfaces = v
}
...
func (o *Interface) SetCableEndNil() {
	o.CableEnd.Set(nil)
}
...
func (o Interface) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["bridge_interfaces"] = o.BridgeInterfaces
	if o.Lag.IsSet() {
...
func (o *Interface) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Interface(varInterface)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "bridge_interfaces")
