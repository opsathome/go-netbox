...
func (r ApiSchemaRetrieveRequest) Brief(brief bool) ApiSchemaRetrieveRequest {
	r.brief = &brief
	return r
}

// Comma-separated list of fields to include in the response. Example: &#x60;fields&#x3D;id,name&#x60;.
func (r ApiSchemaRetrieveRequest) Fields(fields string) ApiSchemaRetrieveRequest {
	r.fields = &fields
	return r
}
...
func (r ApiSchemaRetrieveRequest) Omit(omit string) ApiSchemaRetrieveRequest {
	r.omit = &omit
	return r
}
