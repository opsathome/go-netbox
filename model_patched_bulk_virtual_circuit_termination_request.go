...
// checks if the PatchedBulkVirtualCircuitTerminationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkVirtualCircuitTerminationRequest{}

// PatchedBulkVirtualCircuitTerminationRequest Adds support for custom fields and tags.
type PatchedBulkVirtualCircuitTerminationRequest struct {
	Id                   int32                                               `json:"id"`
	VirtualCircuit       *BulkVirtualCircuitTerminationRequestVirtualCircuit `json:"virtual_circuit,omitempty"`
	Role                 *BulkTunnelTerminationRequestRole                   `json:"role,omitempty"`
	Interface            *BulkVirtualCircuitTerminationRequestInterface      `json:"interface,omitempty"`
...
type _PatchedBulkVirtualCircuitTerminationRequest PatchedBulkVirtualCircuitTerminationRequest
...
func NewPatchedBulkVirtualCircuitTerminationRequest(id int32) *PatchedBulkVirtualCircuitTerminationRequest {
	this := PatchedBulkVirtualCircuitTerminationRequest{}
	this.Id = id
	return &this
}
...
// SetVirtualCircuit gets a reference to the given BulkVirtualCircuitTerminationRequestVirtualCircuit and assigns it to the VirtualCircuit field.
...
// SetInterface gets a reference to the given BulkVirtualCircuitTerminationRequestInterface and assigns it to the Interface field.
...
func (o PatchedBulkVirtualCircuitTerminationRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkVirtualCircuitTerminationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkVirtualCircuitTerminationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkVirtualCircuitTerminationRequest := _PatchedBulkVirtualCircuitTerminationRequest{}

	err = json.Unmarshal(data, &varPatchedBulkVirtualCircuitTerminationRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkVirtualCircuitTerminationRequest(varPatchedBulkVirtualCircuitTerminationRequest)
...
type NullablePatchedBulkVirtualCircuitTerminationRequest struct {
	value *PatchedBulkVirtualCircuitTerminationRequest
	isSet bool
}

func (v NullablePatchedBulkVirtualCircuitTerminationRequest) Get() *PatchedBulkVirtualCircuitTerminationRequest {
	return v.value
}

func (v *NullablePatchedBulkVirtualCircuitTerminationRequest) Set(val *PatchedBulkVirtualCircuitTerminationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkVirtualCircuitTerminationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkVirtualCircuitTerminationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkVirtualCircuitTerminationRequest(val *PatchedBulkVirtualCircuitTerminationRequest) *NullablePatchedBulkVirtualCircuitTerminationRequest {
	return &NullablePatchedBulkVirtualCircuitTerminationRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkVirtualCircuitTerminationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkVirtualCircuitTerminationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
