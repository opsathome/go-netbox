...
// checks if the PatchedBulkVirtualChassisRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkVirtualChassisRequest{}

// PatchedBulkVirtualChassisRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkVirtualChassisRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkVirtualChassisRequest PatchedBulkVirtualChassisRequest
...
func NewPatchedBulkVirtualChassisRequest(id int32) *PatchedBulkVirtualChassisRequest {
	this := PatchedBulkVirtualChassisRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkVirtualChassisRequest) SetMasterNil() {
	o.Master.Set(nil)
}
...
func (o *PatchedBulkVirtualChassisRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkVirtualChassisRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkVirtualChassisRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkVirtualChassisRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkVirtualChassisRequest := _PatchedBulkVirtualChassisRequest{}

	err = json.Unmarshal(data, &varPatchedBulkVirtualChassisRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkVirtualChassisRequest(varPatchedBulkVirtualChassisRequest)
...
type NullablePatchedBulkVirtualChassisRequest struct {
	value *PatchedBulkVirtualChassisRequest
	isSet bool
}

func (v NullablePatchedBulkVirtualChassisRequest) Get() *PatchedBulkVirtualChassisRequest {
	return v.value
}

func (v *NullablePatchedBulkVirtualChassisRequest) Set(val *PatchedBulkVirtualChassisRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkVirtualChassisRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkVirtualChassisRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkVirtualChassisRequest(val *PatchedBulkVirtualChassisRequest) *NullablePatchedBulkVirtualChassisRequest {
	return &NullablePatchedBulkVirtualChassisRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkVirtualChassisRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkVirtualChassisRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
