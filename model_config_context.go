...
// ConfigContext Adds an `owner` field for models which have a ForeignKey to users.Owner.
type ConfigContext struct {
	...
	Profile       NullableBriefConfigContextProfile `json:"profile,omitempty"`
...
func (o *ConfigContext) GetProfile() BriefConfigContextProfile {
	if o == nil || IsNil(o.Profile.Get()) {
		var ret BriefConfigContextProfile
		return ret
	}
...
// SetProfile gets a reference to the given NullableBriefConfigContextProfile and assigns it to the Profile field.
func (o *ConfigContext) SetProfile(v BriefConfigContextProfile) {
	o.Profile.Set(&v)
}

// SetProfileNil sets the value for Profile to be an explicit nil
func (o *ConfigContext) SetProfileNil() {
	o.Profile.Set(nil)
}
...
func (o *ConfigContext) SetOwnerNil() {
	o.Owner.Set(nil)
}
