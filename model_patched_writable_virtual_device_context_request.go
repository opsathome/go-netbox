...
func (o *PatchedWritableVirtualDeviceContextRequest) GetPrimaryIp4() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableVirtualDeviceContextRequest) GetPrimaryIp4Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableVirtualDeviceContextRequest) SetPrimaryIp4(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp4.Set(&v)
}
...
func (o *PatchedWritableVirtualDeviceContextRequest) GetPrimaryIp6() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableVirtualDeviceContextRequest) GetPrimaryIp6Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableVirtualDeviceContextRequest) SetPrimaryIp6(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp6.Set(&v)
}
