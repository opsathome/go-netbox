...
// PatchedWritableEventRuleRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritableEventRuleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
