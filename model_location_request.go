...
// LocationRequest Base serializer class for models inheriting from NestedGroupModel.
...
func NewLocationRequest(name string, slug string, site BulkDeviceWithConfigContextRequestSite) *LocationRequest {
...
func (o *LocationRequest) GetSite() BulkDeviceWithConfigContextRequestSite {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LocationRequest) GetSiteOk() (*BulkDeviceWithConfigContextRequestSite, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Site, true
...
func (o *LocationRequest) SetSite(v BulkDeviceWithConfigContextRequestSite) {
	o.Site = v
}
...
func (o *LocationRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
