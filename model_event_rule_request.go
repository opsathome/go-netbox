...
// EventRuleRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func NewEventRuleRequest(objectTypes []string, name string, eventTypes []BulkEventRuleRequestEventTypesInner, actionType BulkEventRuleRequestActionType, actionObjectType string) *EventRuleRequest {
...
func (o *EventRuleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
