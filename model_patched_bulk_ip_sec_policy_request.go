...
// checks if the PatchedBulkIPSecPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkIPSecPolicyRequest{}

// PatchedBulkIPSecPolicyRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkIPSecPolicyRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkIPSecPolicyRequest PatchedBulkIPSecPolicyRequest
...
func NewPatchedBulkIPSecPolicyRequest(id int32) *PatchedBulkIPSecPolicyRequest {
	this := PatchedBulkIPSecPolicyRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkIPSecPolicyRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkIPSecPolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkIPSecPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkIPSecPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkIPSecPolicyRequest := _PatchedBulkIPSecPolicyRequest{}

	err = json.Unmarshal(data, &varPatchedBulkIPSecPolicyRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkIPSecPolicyRequest(varPatchedBulkIPSecPolicyRequest)
...
type NullablePatchedBulkIPSecPolicyRequest struct {
	value *PatchedBulkIPSecPolicyRequest
	isSet bool
}

func (v NullablePatchedBulkIPSecPolicyRequest) Get() *PatchedBulkIPSecPolicyRequest {
	return v.value
}

func (v *NullablePatchedBulkIPSecPolicyRequest) Set(val *PatchedBulkIPSecPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkIPSecPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkIPSecPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkIPSecPolicyRequest(val *PatchedBulkIPSecPolicyRequest) *NullablePatchedBulkIPSecPolicyRequest {
	return &NullablePatchedBulkIPSecPolicyRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkIPSecPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkIPSecPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
