...
// PatchedRackGroupRequest Base serializer class for models inheriting from OrganizationalModel.
...
func (o *PatchedRackGroupRequest) GetSlug() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedRackGroupRequest) GetSlugOk() (*string, bool) {
	if o == nil || IsNil(o.Slug) {
		return nil, false
	}
	return o.Slug, true
...
func (o *PatchedRackGroupRequest) HasSlug() bool {
	if o != nil && !IsNil(o.Slug) {
		return true
	}
...
func (o *PatchedRackGroupRequest) SetSlug(v string) {
	o.Slug = &v
}
...
func (o *PatchedRackGroupRequest) GetOwner() ASNRangeRequestOwner {
...
func (o *PatchedRackGroupRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedRackGroupRequest) HasOwner() bool {
...
func (o *PatchedRackGroupRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedRackGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *PatchedRackGroupRequest) UnsetOwner() {
	o.Owner.Unset()
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *PatchedRackGroupRequest) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedRackGroupRequest) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *PatchedRackGroupRequest) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
...
func (o *PatchedRackGroupRequest) SetComments(v string) {
	o.Comments = &v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *PatchedRackGroupRequest) GetTags() []NestedTagRequest {
...
// and a boolean to check if the value has been set.
func (o *PatchedRackGroupRequest) GetTagsOk() ([]NestedTagRequest, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *PatchedRackGroupRequest) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *PatchedRackGroupRequest) SetTags(v []NestedTagRequest) {
	o.Tags = v
}
