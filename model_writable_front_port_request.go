...
func NewWritableFrontPortRequest(device BriefInterfaceRequestDevice, name string, type_ BulkFrontPortRequestType) *WritableFrontPortRequest {
...
func (o *WritableFrontPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *WritableFrontPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *WritableFrontPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
