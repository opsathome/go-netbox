...
func (dst *BriefModuleTypeRequestProfile) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefModuleTypeRequestProfile): %v", err)
		} else {
...
func (obj BriefModuleTypeRequestProfile) GetActualInstanceValue() interface{} {
	if obj.BriefModuleTypeProfileRequest != nil {
		return *obj.BriefModuleTypeProfileRequest
	}
