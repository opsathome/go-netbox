...
// VirtualDeviceContextRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewVirtualDeviceContextRequest(name string, device BriefInterfaceRequestDevice, status BulkVirtualDeviceContextRequestStatus) *VirtualDeviceContextRequest {
...
func (o *VirtualDeviceContextRequest) GetPrimaryIp4() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VirtualDeviceContextRequest) GetPrimaryIp4Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualDeviceContextRequest) SetPrimaryIp4(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp4.Set(&v)
}
...
func (o *VirtualDeviceContextRequest) GetPrimaryIp6() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VirtualDeviceContextRequest) GetPrimaryIp6Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualDeviceContextRequest) SetPrimaryIp6(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp6.Set(&v)
}
...
func (o *VirtualDeviceContextRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
