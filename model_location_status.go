...
type LocationStatus struct {
	Value                *BulkLocationRequestStatus `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkLocationRequestStatus and assigns it to the Value field.
