...
// RearPort Adds an `owner` field for models which have a ForeignKey to users.Owner.
type RearPort struct {
	...
	FrontPorts  []RearPortMapping      `json:"front_ports,omitempty"`
...
func (o *RearPort) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *RearPort) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *RearPort) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
// SetFrontPorts gets a reference to the given []RearPortMapping and assigns it to the FrontPorts field.
...
func (o *RearPort) SetCableEndNil() {
	o.CableEnd.Set(nil)
}
