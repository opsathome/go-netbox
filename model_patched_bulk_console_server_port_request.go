...
// checks if the PatchedBulkConsoleServerPortRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkConsoleServerPortRequest{}

// PatchedBulkConsoleServerPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkConsoleServerPortRequest struct {
	Id     int32                                `json:"id"`
...
type _PatchedBulkConsoleServerPortRequest PatchedBulkConsoleServerPortRequest
...
func NewPatchedBulkConsoleServerPortRequest(id int32) *PatchedBulkConsoleServerPortRequest {
	this := PatchedBulkConsoleServerPortRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkConsoleServerPortRequest) GetDevice() BriefInterfaceRequestDevice {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkConsoleServerPortRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil || IsNil(o.Device) {
		return nil, false
	}
...
func (o *PatchedBulkConsoleServerPortRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = &v
}
...
func (o *PatchedBulkConsoleServerPortRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *PatchedBulkConsoleServerPortRequest) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
func (o *PatchedBulkConsoleServerPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkConsoleServerPortRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkConsoleServerPortRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkConsoleServerPortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkConsoleServerPortRequest := _PatchedBulkConsoleServerPortRequest{}

	err = json.Unmarshal(data, &varPatchedBulkConsoleServerPortRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkConsoleServerPortRequest(varPatchedBulkConsoleServerPortRequest)
...
type NullablePatchedBulkConsoleServerPortRequest struct {
	value *PatchedBulkConsoleServerPortRequest
	isSet bool
}

func (v NullablePatchedBulkConsoleServerPortRequest) Get() *PatchedBulkConsoleServerPortRequest {
	return v.value
}

func (v *NullablePatchedBulkConsoleServerPortRequest) Set(val *PatchedBulkConsoleServerPortRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkConsoleServerPortRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkConsoleServerPortRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkConsoleServerPortRequest(val *PatchedBulkConsoleServerPortRequest) *NullablePatchedBulkConsoleServerPortRequest {
	return &NullablePatchedBulkConsoleServerPortRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkConsoleServerPortRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkConsoleServerPortRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
