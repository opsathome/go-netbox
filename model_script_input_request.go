...
type ScriptInputRequest struct {
	...
	Notifications        *ScriptInputRequestNotifications `json:"notifications,omitempty"`
...
func NewScriptInputRequest(data interface{}, commit bool) *ScriptInputRequest {
	...
	this.Data = data
	this.Commit = commit
	var notifications ScriptInputRequestNotifications = SCRIPTINPUTREQUESTNOTIFICATIONS_ALWAYS
...
func (o *ScriptInputRequest) GetNotifications() ScriptInputRequestNotifications {
	if o == nil || IsNil(o.Notifications) {
		var ret ScriptInputRequestNotifications
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScriptInputRequest) GetNotificationsOk() (*ScriptInputRequestNotifications, bool) {
	if o == nil || IsNil(o.Notifications) {
		return nil, false
	}
...
func (o *ScriptInputRequest) HasNotifications() bool {
	if o != nil && !IsNil(o.Notifications) {
		return true
	}
...
// SetNotifications gets a reference to the given ScriptInputRequestNotifications and assigns it to the Notifications field.
func (o *ScriptInputRequest) SetNotifications(v ScriptInputRequestNotifications) {
	o.Notifications = &v
}
