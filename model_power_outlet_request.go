...
// PowerOutletRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PowerOutletRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PowerOutletRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PowerOutletRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PowerOutletRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
