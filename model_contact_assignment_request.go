...
func NewContactAssignmentRequest(objectType string, objectId int64, contact BulkContactAssignmentRequestContact) *ContactAssignmentRequest {
...
func (o *ContactAssignmentRequest) GetContact() BulkContactAssignmentRequestContact {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ContactAssignmentRequest) GetContactOk() (*BulkContactAssignmentRequestContact, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ContactAssignmentRequest) SetContact(v BulkContactAssignmentRequestContact) {
	o.Contact = v
}

// GetRole returns the Role field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ContactAssignmentRequest) GetRole() BulkContactAssignmentRequestRole {
...
func (o *ContactAssignmentRequest) GetRoleOk() (*BulkContactAssignmentRequestRole, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ContactAssignmentRequest) SetRole(v BulkContactAssignmentRequestRole) {
	o.Role.Set(&v)
}
