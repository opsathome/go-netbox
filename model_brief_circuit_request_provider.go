...
func (dst *BriefCircuitRequestProvider) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefCircuitRequestProvider): %v", err)
		} else {
...
func (obj BriefCircuitRequestProvider) GetActualInstanceValue() interface{} {
	if obj.BriefProviderRequest != nil {
		return *obj.BriefProviderRequest
	}
