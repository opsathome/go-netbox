...
func (o *PatchedWritableRackReservationRequest) GetRack() BulkRackReservationRequestRack {
...
func (o *PatchedWritableRackReservationRequest) GetRackOk() (*BulkRackReservationRequestRack, bool) {
	if o == nil || IsNil(o.Rack) {
		return nil, false
	}
	return o.Rack, true
...
func (o *PatchedWritableRackReservationRequest) SetRack(v BulkRackReservationRequestRack) {
	o.Rack = &v
}
...
func (o *PatchedWritableRackReservationRequest) GetStatus() BulkRackReservationRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableRackReservationRequest) GetStatusOk() (*BulkRackReservationRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedWritableRackReservationRequest) SetStatus(v BulkRackReservationRequestStatus) {
	o.Status = &v
}
