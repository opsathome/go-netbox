...
// checks if the PatchedBulkIPRangeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkIPRangeRequest{}

// PatchedBulkIPRangeRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkIPRangeRequest struct {
	Id           int32                           `json:"id"`
...
type _PatchedBulkIPRangeRequest PatchedBulkIPRangeRequest
...
func NewPatchedBulkIPRangeRequest(id int32) *PatchedBulkIPRangeRequest {
	this := PatchedBulkIPRangeRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkIPRangeRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *PatchedBulkIPRangeRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkIPRangeRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *PatchedBulkIPRangeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkIPRangeRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkIPRangeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkIPRangeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkIPRangeRequest := _PatchedBulkIPRangeRequest{}

	err = json.Unmarshal(data, &varPatchedBulkIPRangeRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkIPRangeRequest(varPatchedBulkIPRangeRequest)
...
type NullablePatchedBulkIPRangeRequest struct {
	value *PatchedBulkIPRangeRequest
	isSet bool
}

func (v NullablePatchedBulkIPRangeRequest) Get() *PatchedBulkIPRangeRequest {
	return v.value
}

func (v *NullablePatchedBulkIPRangeRequest) Set(val *PatchedBulkIPRangeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkIPRangeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkIPRangeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkIPRangeRequest(val *PatchedBulkIPRangeRequest) *NullablePatchedBulkIPRangeRequest {
	return &NullablePatchedBulkIPRangeRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkIPRangeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkIPRangeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
