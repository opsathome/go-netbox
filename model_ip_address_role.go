...
type IPAddressRole struct {
	Value                *BulkIPAddressRequestRole `json:"value,omitempty"`
...
func (o *IPAddressRole) GetValue() BulkIPAddressRequestRole {
...
func (o *IPAddressRole) GetValueOk() (*BulkIPAddressRequestRole, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkIPAddressRequestRole and assigns it to the Value field.
func (o *IPAddressRole) SetValue(v BulkIPAddressRequestRole) {
	o.Value = &v
}
