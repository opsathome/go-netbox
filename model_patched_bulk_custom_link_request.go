...
// checks if the PatchedBulkCustomLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkCustomLinkRequest{}

// PatchedBulkCustomLinkRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkCustomLinkRequest struct {
	Id          int32    `json:"id"`
	...
	ButtonClass *BulkCustomLinkRequestButtonClass `json:"button_class,omitempty"`
...
type _PatchedBulkCustomLinkRequest PatchedBulkCustomLinkRequest
...
func NewPatchedBulkCustomLinkRequest(id int32) *PatchedBulkCustomLinkRequest {
	this := PatchedBulkCustomLinkRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkCustomLinkRequest) GetButtonClass() BulkCustomLinkRequestButtonClass {
	if o == nil || IsNil(o.ButtonClass) {
		var ret BulkCustomLinkRequestButtonClass
		return ret
	}
...
// SetButtonClass gets a reference to the given BulkCustomLinkRequestButtonClass and assigns it to the ButtonClass field.
...
func (o *PatchedBulkCustomLinkRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkCustomLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkCustomLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkCustomLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkCustomLinkRequest := _PatchedBulkCustomLinkRequest{}

	err = json.Unmarshal(data, &varPatchedBulkCustomLinkRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkCustomLinkRequest(varPatchedBulkCustomLinkRequest)
...
type NullablePatchedBulkCustomLinkRequest struct {
	value *PatchedBulkCustomLinkRequest
	isSet bool
}

func (v NullablePatchedBulkCustomLinkRequest) Get() *PatchedBulkCustomLinkRequest {
	return v.value
}

func (v *NullablePatchedBulkCustomLinkRequest) Set(val *PatchedBulkCustomLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkCustomLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkCustomLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkCustomLinkRequest(val *PatchedBulkCustomLinkRequest) *NullablePatchedBulkCustomLinkRequest {
	return &NullablePatchedBulkCustomLinkRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkCustomLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkCustomLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
