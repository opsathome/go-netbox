...
// WritablePowerFeedRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *WritablePowerFeedRequest) GetRack() BulkDeviceWithConfigContextRequestRack {
...
func (o *WritablePowerFeedRequest) GetRackOk() (*BulkDeviceWithConfigContextRequestRack, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritablePowerFeedRequest) SetRack(v BulkDeviceWithConfigContextRequestRack) {
	o.Rack.Set(&v)
}
...
func (o *WritablePowerFeedRequest) GetStatus() BulkPowerFeedRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *WritablePowerFeedRequest) GetStatusOk() (*BulkPowerFeedRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritablePowerFeedRequest) SetStatus(v BulkPowerFeedRequestStatus) {
	o.Status = &v
}
...
func (o *WritablePowerFeedRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
