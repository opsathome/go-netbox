...
// checks if the PatchedBulkContactAssignmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkContactAssignmentRequest{}

// PatchedBulkContactAssignmentRequest Adds support for custom fields and tags.
type PatchedBulkContactAssignmentRequest struct {
	Id                   int32                                               `json:"id"`
	ObjectType           *string                                             `json:"object_type,omitempty"`
	ObjectId             *int64                                              `json:"object_id,omitempty"`
	Contact              *BulkContactAssignmentRequestContact                `json:"contact,omitempty"`
	Role                 NullableBulkContactAssignmentRequestRole            `json:"role,omitempty"`
...
type _PatchedBulkContactAssignmentRequest PatchedBulkContactAssignmentRequest
...
func NewPatchedBulkContactAssignmentRequest(id int32) *PatchedBulkContactAssignmentRequest {
	this := PatchedBulkContactAssignmentRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkContactAssignmentRequest) GetContact() BulkContactAssignmentRequestContact {
	if o == nil || IsNil(o.Contact) {
		var ret BulkContactAssignmentRequestContact
		return ret
	}
	return *o.Contact
}
...
// SetContact gets a reference to the given BulkContactAssignmentRequestContact and assigns it to the Contact field.
...
func (o *PatchedBulkContactAssignmentRequest) GetRole() BulkContactAssignmentRequestRole {
	if o == nil || IsNil(o.Role.Get()) {
		var ret BulkContactAssignmentRequestRole
		return ret
	}
	return *o.Role.Get()
}
...
// SetRole gets a reference to the given NullableBulkContactAssignmentRequestRole and assigns it to the Role field.
func (o *PatchedBulkContactAssignmentRequest) SetRole(v BulkContactAssignmentRequestRole) {
	o.Role.Set(&v)
}

// SetRoleNil sets the value for Role to be an explicit nil
func (o *PatchedBulkContactAssignmentRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o PatchedBulkContactAssignmentRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkContactAssignmentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkContactAssignmentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkContactAssignmentRequest := _PatchedBulkContactAssignmentRequest{}

	err = json.Unmarshal(data, &varPatchedBulkContactAssignmentRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkContactAssignmentRequest(varPatchedBulkContactAssignmentRequest)
...
type NullablePatchedBulkContactAssignmentRequest struct {
	value *PatchedBulkContactAssignmentRequest
	isSet bool
}

func (v NullablePatchedBulkContactAssignmentRequest) Get() *PatchedBulkContactAssignmentRequest {
	return v.value
}

func (v *NullablePatchedBulkContactAssignmentRequest) Set(val *PatchedBulkContactAssignmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkContactAssignmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkContactAssignmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkContactAssignmentRequest(val *PatchedBulkContactAssignmentRequest) *NullablePatchedBulkContactAssignmentRequest {
	return &NullablePatchedBulkContactAssignmentRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkContactAssignmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkContactAssignmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
