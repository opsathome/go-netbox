...
// PowerOutlet Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PowerOutlet) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PowerOutlet) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PowerOutlet) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PowerOutlet) SetCableEndNil() {
	o.CableEnd.Set(nil)
}
...
func (o *PowerOutlet) SetOwnerNil() {
	o.Owner.Set(nil)
}
