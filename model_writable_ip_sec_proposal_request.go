...
// WritableIPSecProposalRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *WritableIPSecProposalRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableIPSecProposalRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableIPSecProposalRequest) HasOwner() bool {
...
func (o *WritableIPSecProposalRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *WritableIPSecProposalRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *WritableIPSecProposalRequest) UnsetOwner() {
	o.Owner.Unset()
}
