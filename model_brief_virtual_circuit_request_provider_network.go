...
func (dst *BriefVirtualCircuitRequestProviderNetwork) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefVirtualCircuitRequestProviderNetwork): %v", err)
		} else {
...
func (obj BriefVirtualCircuitRequestProviderNetwork) GetActualInstanceValue() interface{} {
	if obj.BriefProviderNetworkRequest != nil {
		return *obj.BriefProviderNetworkRequest
	}
