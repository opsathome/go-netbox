...
// checks if the BulkCustomFieldRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkCustomFieldRequest{}

// BulkCustomFieldRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkCustomFieldRequest struct {
	Id                int32                      `json:"id"`
	ObjectTypes       []string                   `json:"object_types"`
	Type              BulkCustomFieldRequestType `json:"type"`
...
type _BulkCustomFieldRequest BulkCustomFieldRequest
...
func (o *BulkCustomFieldRequest) SetRelatedObjectTypeNil() {
...
func (o *BulkCustomFieldRequest) SetValidationMinimumNil() {
...
func (o *BulkCustomFieldRequest) SetValidationMaximumNil() {
...
func (o *BulkCustomFieldRequest) SetChoiceSetNil() {
	o.ChoiceSet.Set(nil)
}
...
func (o *BulkCustomFieldRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkCustomFieldRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkCustomFieldRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkCustomFieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkCustomFieldRequest := _BulkCustomFieldRequest{}

	err = json.Unmarshal(data, &varBulkCustomFieldRequest)

	if err != nil {
		return err
	}

	*o = BulkCustomFieldRequest(varBulkCustomFieldRequest)
...
type NullableBulkCustomFieldRequest struct {
	value *BulkCustomFieldRequest
	isSet bool
}

func (v NullableBulkCustomFieldRequest) Get() *BulkCustomFieldRequest {
	return v.value
}

func (v *NullableBulkCustomFieldRequest) Set(val *BulkCustomFieldRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkCustomFieldRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkCustomFieldRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkCustomFieldRequest(val *BulkCustomFieldRequest) *NullableBulkCustomFieldRequest {
	return &NullableBulkCustomFieldRequest{value: val, isSet: true}
}

func (v NullableBulkCustomFieldRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkCustomFieldRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
