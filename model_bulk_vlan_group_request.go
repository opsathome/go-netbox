...
// checks if the BulkVLANGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkVLANGroupRequest{}

// BulkVLANGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkVLANGroupRequest struct {
	Id                   int32                         `json:"id"`
...
type _BulkVLANGroupRequest BulkVLANGroupRequest
...
func (o *BulkVLANGroupRequest) SetScopeTypeNil() {
	o.ScopeType.Set(nil)
}
...
func (o *BulkVLANGroupRequest) SetScopeIdNil() {
	o.ScopeId.Set(nil)
}
...
func (o *BulkVLANGroupRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkVLANGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkVLANGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkVLANGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkVLANGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkVLANGroupRequest := _BulkVLANGroupRequest{}

	err = json.Unmarshal(data, &varBulkVLANGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkVLANGroupRequest(varBulkVLANGroupRequest)
...
type NullableBulkVLANGroupRequest struct {
	value *BulkVLANGroupRequest
	isSet bool
}

func (v NullableBulkVLANGroupRequest) Get() *BulkVLANGroupRequest {
	return v.value
}

func (v *NullableBulkVLANGroupRequest) Set(val *BulkVLANGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkVLANGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkVLANGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkVLANGroupRequest(val *BulkVLANGroupRequest) *NullableBulkVLANGroupRequest {
	return &NullableBulkVLANGroupRequest{value: val, isSet: true}
}

func (v NullableBulkVLANGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkVLANGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
