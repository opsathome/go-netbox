...
// checks if the PatchedBulkIKEPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkIKEPolicyRequest{}

// PatchedBulkIKEPolicyRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkIKEPolicyRequest struct {
	Id                   int32                        `json:"id"`
	Name                 *string                      `json:"name,omitempty"`
	Description          *string                      `json:"description,omitempty"`
	Version              *BulkIKEPolicyRequestVersion `json:"version,omitempty"`
	Mode                 *BulkIKEPolicyRequestMode    `json:"mode,omitempty"`
...
type _PatchedBulkIKEPolicyRequest PatchedBulkIKEPolicyRequest
...
func NewPatchedBulkIKEPolicyRequest(id int32) *PatchedBulkIKEPolicyRequest {
	this := PatchedBulkIKEPolicyRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkIKEPolicyRequest) GetVersion() BulkIKEPolicyRequestVersion {
	if o == nil || IsNil(o.Version) {
		var ret BulkIKEPolicyRequestVersion
		return ret
	}
	return *o.Version
}
...
// SetVersion gets a reference to the given BulkIKEPolicyRequestVersion and assigns it to the Version field.
...
func (o *PatchedBulkIKEPolicyRequest) GetMode() BulkIKEPolicyRequestMode {
	if o == nil || IsNil(o.Mode) {
		var ret BulkIKEPolicyRequestMode
		return ret
	}
	return *o.Mode
}
...
// SetMode gets a reference to the given BulkIKEPolicyRequestMode and assigns it to the Mode field.
...
func (o *PatchedBulkIKEPolicyRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkIKEPolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkIKEPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkIKEPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkIKEPolicyRequest := _PatchedBulkIKEPolicyRequest{}

	err = json.Unmarshal(data, &varPatchedBulkIKEPolicyRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkIKEPolicyRequest(varPatchedBulkIKEPolicyRequest)
...
type NullablePatchedBulkIKEPolicyRequest struct {
	value *PatchedBulkIKEPolicyRequest
	isSet bool
}

func (v NullablePatchedBulkIKEPolicyRequest) Get() *PatchedBulkIKEPolicyRequest {
	return v.value
}

func (v *NullablePatchedBulkIKEPolicyRequest) Set(val *PatchedBulkIKEPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkIKEPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkIKEPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkIKEPolicyRequest(val *PatchedBulkIKEPolicyRequest) *NullablePatchedBulkIKEPolicyRequest {
	return &NullablePatchedBulkIKEPolicyRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkIKEPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkIKEPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
