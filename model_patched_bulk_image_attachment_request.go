...
// checks if the PatchedBulkImageAttachmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkImageAttachmentRequest{}

// PatchedBulkImageAttachmentRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
type PatchedBulkImageAttachmentRequest struct {
	Id                   int32     `json:"id"`
...
type _PatchedBulkImageAttachmentRequest PatchedBulkImageAttachmentRequest
...
func NewPatchedBulkImageAttachmentRequest(id int32) *PatchedBulkImageAttachmentRequest {
	this := PatchedBulkImageAttachmentRequest{}
	this.Id = id
	return &this
}
...
func (o PatchedBulkImageAttachmentRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkImageAttachmentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkImageAttachmentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkImageAttachmentRequest := _PatchedBulkImageAttachmentRequest{}

	err = json.Unmarshal(data, &varPatchedBulkImageAttachmentRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkImageAttachmentRequest(varPatchedBulkImageAttachmentRequest)
...
type NullablePatchedBulkImageAttachmentRequest struct {
	value *PatchedBulkImageAttachmentRequest
	isSet bool
}

func (v NullablePatchedBulkImageAttachmentRequest) Get() *PatchedBulkImageAttachmentRequest {
	return v.value
}

func (v *NullablePatchedBulkImageAttachmentRequest) Set(val *PatchedBulkImageAttachmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkImageAttachmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkImageAttachmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkImageAttachmentRequest(val *PatchedBulkImageAttachmentRequest) *NullablePatchedBulkImageAttachmentRequest {
	return &NullablePatchedBulkImageAttachmentRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkImageAttachmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkImageAttachmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
