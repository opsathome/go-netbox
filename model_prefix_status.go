...
type PrefixStatus struct {
	Value                *BulkPrefixRequestStatus `json:"value,omitempty"`
...
func (o *PrefixStatus) GetValue() BulkPrefixRequestStatus {
...
func (o *PrefixStatus) GetValueOk() (*BulkPrefixRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkPrefixRequestStatus and assigns it to the Value field.
func (o *PrefixStatus) SetValue(v BulkPrefixRequestStatus) {
	o.Value = &v
}
