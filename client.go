...
// APIClient manages communication with the NetBox REST API API v4.6.8-Docker-5.0.2 (4.6)
...
type APIClient struct {
	...
	AuthenticationCheckAPI AuthenticationCheckAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AuthenticationCheckAPI = (*AuthenticationCheckAPIService)(&c.common)
