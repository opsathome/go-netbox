...
type PowerFeedPhase struct {
	Value                *BulkPowerFeedRequestPhase `json:"value,omitempty"`
...
func (o *PowerFeedPhase) GetValue() BulkPowerFeedRequestPhase {
...
func (o *PowerFeedPhase) GetValueOk() (*BulkPowerFeedRequestPhase, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkPowerFeedRequestPhase and assigns it to the Value field.
func (o *PowerFeedPhase) SetValue(v BulkPowerFeedRequestPhase) {
	o.Value = &v
}
