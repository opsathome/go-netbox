...
type FrontPort struct {
	...
	CableEnd      NullableCircuitTerminationCableEnd `json:"cable_end,omitempty"`
...
func NewFrontPort(id int32, url string, display string, device BriefDevice, name string, type_ FrontPortType, linkPeers []interface{}, occupied bool) *FrontPort {
	this := FrontPort{}
	this.Id = id
	this.Url = url
...
func (o *FrontPort) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *FrontPort) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *FrontPort) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
// SetRearPorts gets a reference to the given []FrontPortMapping and assigns it to the RearPorts field.
...
// GetCableEnd returns the CableEnd field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FrontPort) GetCableEnd() CircuitTerminationCableEnd {
	if o == nil || IsNil(o.CableEnd.Get()) {
		var ret CircuitTerminationCableEnd
		return ret
	}
	return *o.CableEnd.Get()
}
...
// SetCableEnd gets a reference to the given NullableCircuitTerminationCableEnd and assigns it to the CableEnd field.
...
func (o *FrontPort) SetCableEndNil() {
	o.CableEnd.Set(nil)
}
...
func (o FrontPort) ToMap() (map[string]interface{}, error) {
	...
	if o.CableEnd.IsSet() {
		toSerialize["cable_end"] = o.CableEnd.Get()
	}
