...
type FrontPortType struct {
	Value                *BulkFrontPortRequestType `json:"value,omitempty"`
...
func (o *FrontPortType) GetValue() BulkFrontPortRequestType {
...
func (o *FrontPortType) GetValueOk() (*BulkFrontPortRequestType, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkFrontPortRequestType and assigns it to the Value field.
func (o *FrontPortType) SetValue(v BulkFrontPortRequestType) {
	o.Value = &v
}
