...
// checks if the BulkVirtualChassisRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkVirtualChassisRequest{}

// BulkVirtualChassisRequest Base serializer class for models inheriting from PrimaryModel.
type BulkVirtualChassisRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkVirtualChassisRequest BulkVirtualChassisRequest
...
func NewBulkVirtualChassisRequest(id int32, name string) *BulkVirtualChassisRequest {
	this := BulkVirtualChassisRequest{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BulkVirtualChassisRequest) SetMasterNil() {
	o.Master.Set(nil)
}
...
func (o *BulkVirtualChassisRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkVirtualChassisRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkVirtualChassisRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkVirtualChassisRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkVirtualChassisRequest := _BulkVirtualChassisRequest{}

	err = json.Unmarshal(data, &varBulkVirtualChassisRequest)

	if err != nil {
		return err
	}

	*o = BulkVirtualChassisRequest(varBulkVirtualChassisRequest)
...
type NullableBulkVirtualChassisRequest struct {
	value *BulkVirtualChassisRequest
	isSet bool
}

func (v NullableBulkVirtualChassisRequest) Get() *BulkVirtualChassisRequest {
	return v.value
}

func (v *NullableBulkVirtualChassisRequest) Set(val *BulkVirtualChassisRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkVirtualChassisRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkVirtualChassisRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkVirtualChassisRequest(val *BulkVirtualChassisRequest) *NullableBulkVirtualChassisRequest {
	return &NullableBulkVirtualChassisRequest{value: val, isSet: true}
}

func (v NullableBulkVirtualChassisRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkVirtualChassisRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
