...
// checks if the PatchedBulkFHRPGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkFHRPGroupRequest{}

// PatchedBulkFHRPGroupRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkFHRPGroupRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkFHRPGroupRequest PatchedBulkFHRPGroupRequest
...
func NewPatchedBulkFHRPGroupRequest(id int32) *PatchedBulkFHRPGroupRequest {
	this := PatchedBulkFHRPGroupRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkFHRPGroupRequest) SetAuthTypeNil() {
	o.AuthType.Set(nil)
}
...
func (o *PatchedBulkFHRPGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkFHRPGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkFHRPGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkFHRPGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkFHRPGroupRequest := _PatchedBulkFHRPGroupRequest{}

	err = json.Unmarshal(data, &varPatchedBulkFHRPGroupRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkFHRPGroupRequest(varPatchedBulkFHRPGroupRequest)
...
type NullablePatchedBulkFHRPGroupRequest struct {
	value *PatchedBulkFHRPGroupRequest
	isSet bool
}

func (v NullablePatchedBulkFHRPGroupRequest) Get() *PatchedBulkFHRPGroupRequest {
	return v.value
}

func (v *NullablePatchedBulkFHRPGroupRequest) Set(val *PatchedBulkFHRPGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkFHRPGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkFHRPGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkFHRPGroupRequest(val *PatchedBulkFHRPGroupRequest) *NullablePatchedBulkFHRPGroupRequest {
	return &NullablePatchedBulkFHRPGroupRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkFHRPGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkFHRPGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
