...
func (r ApiStatusRetrieveRequest) Brief(brief bool) ApiStatusRetrieveRequest {
	r.brief = &brief
	return r
}

// Comma-separated list of fields to include in the response. Example: &#x60;fields&#x3D;id,name&#x60;.
func (r ApiStatusRetrieveRequest) Fields(fields string) ApiStatusRetrieveRequest {
	r.fields = &fields
	return r
}

// Comma-separated list of fields to exclude from the response. Example: &#x60;omit&#x3D;description,tags&#x60;.
func (r ApiStatusRetrieveRequest) Omit(omit string) ApiStatusRetrieveRequest {
	r.omit = &omit
	return r
}
