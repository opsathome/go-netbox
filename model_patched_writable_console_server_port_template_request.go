...
func (o *PatchedWritableConsoleServerPortTemplateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType {
...
func (o *PatchedWritableConsoleServerPortTemplateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableConsoleServerPortTemplateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType) {
	o.DeviceType.Set(&v)
}
...
func (o *PatchedWritableConsoleServerPortTemplateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableConsoleServerPortTemplateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableConsoleServerPortTemplateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType) {
	o.ModuleType.Set(&v)
}
