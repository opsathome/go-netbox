...
type PowerOutletStatus struct {
	Value                *BulkPowerOutletRequestStatus `json:"value,omitempty"`
...
func (o *PowerOutletStatus) GetValue() BulkPowerOutletRequestStatus {
...
func (o *PowerOutletStatus) GetValueOk() (*BulkPowerOutletRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkPowerOutletRequestStatus and assigns it to the Value field.
func (o *PowerOutletStatus) SetValue(v BulkPowerOutletRequestStatus) {
	o.Value = &v
}
