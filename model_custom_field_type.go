...
type CustomFieldType struct {
	Value                *BulkCustomFieldRequestType `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkCustomFieldRequestType and assigns it to the Value field.
