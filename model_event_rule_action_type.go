...
type EventRuleActionType struct {
	Value                *BulkEventRuleRequestActionType `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkEventRuleRequestActionType and assigns it to the Value field.
