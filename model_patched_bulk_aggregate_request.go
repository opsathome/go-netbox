...
// checks if the PatchedBulkAggregateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkAggregateRequest{}

// PatchedBulkAggregateRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkAggregateRequest struct {
	Id                   int32                         `json:"id"`
...
type _PatchedBulkAggregateRequest PatchedBulkAggregateRequest
...
func NewPatchedBulkAggregateRequest(id int32) *PatchedBulkAggregateRequest {
	this := PatchedBulkAggregateRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkAggregateRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkAggregateRequest) SetDateAddedNil() {
	o.DateAdded.Set(nil)
}
...
func (o *PatchedBulkAggregateRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkAggregateRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkAggregateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkAggregateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkAggregateRequest := _PatchedBulkAggregateRequest{}

	err = json.Unmarshal(data, &varPatchedBulkAggregateRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkAggregateRequest(varPatchedBulkAggregateRequest)
...
type NullablePatchedBulkAggregateRequest struct {
	value *PatchedBulkAggregateRequest
	isSet bool
}

func (v NullablePatchedBulkAggregateRequest) Get() *PatchedBulkAggregateRequest {
	return v.value
}

func (v *NullablePatchedBulkAggregateRequest) Set(val *PatchedBulkAggregateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkAggregateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkAggregateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkAggregateRequest(val *PatchedBulkAggregateRequest) *NullablePatchedBulkAggregateRequest {
	return &NullablePatchedBulkAggregateRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkAggregateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkAggregateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
