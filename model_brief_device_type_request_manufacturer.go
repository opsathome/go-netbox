...
func (dst *BriefDeviceTypeRequestManufacturer) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefDeviceTypeRequestManufacturer): %v", err)
		} else {
...
func (obj BriefDeviceTypeRequestManufacturer) GetActualInstanceValue() interface{} {
	if obj.BriefManufacturerRequest != nil {
		return *obj.BriefManufacturerRequest
	}
