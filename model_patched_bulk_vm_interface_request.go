...
// checks if the PatchedBulkVMInterfaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkVMInterfaceRequest{}

// PatchedBulkVMInterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkVMInterfaceRequest struct {
	Id                    int32                                             `json:"id"`
...
type _PatchedBulkVMInterfaceRequest PatchedBulkVMInterfaceRequest
...
func NewPatchedBulkVMInterfaceRequest(id int32) *PatchedBulkVMInterfaceRequest {
	this := PatchedBulkVMInterfaceRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkVMInterfaceRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *PatchedBulkVMInterfaceRequest) SetBridgeNil() {
	o.Bridge.Set(nil)
}
...
func (o *PatchedBulkVMInterfaceRequest) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *PatchedBulkVMInterfaceRequest) SetPrimaryMacAddressNil() {
...
func (o *PatchedBulkVMInterfaceRequest) SetUntaggedVlanNil() {
...
func (o *PatchedBulkVMInterfaceRequest) SetQinqSvlanNil() {
	o.QinqSvlan.Set(nil)
}
...
func (o *PatchedBulkVMInterfaceRequest) SetVlanTranslationPolicyNil() {
...
func (o *PatchedBulkVMInterfaceRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *PatchedBulkVMInterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkVMInterfaceRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkVMInterfaceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkVMInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkVMInterfaceRequest := _PatchedBulkVMInterfaceRequest{}

	err = json.Unmarshal(data, &varPatchedBulkVMInterfaceRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkVMInterfaceRequest(varPatchedBulkVMInterfaceRequest)
...
type NullablePatchedBulkVMInterfaceRequest struct {
	value *PatchedBulkVMInterfaceRequest
	isSet bool
}

func (v NullablePatchedBulkVMInterfaceRequest) Get() *PatchedBulkVMInterfaceRequest {
	return v.value
}

func (v *NullablePatchedBulkVMInterfaceRequest) Set(val *PatchedBulkVMInterfaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkVMInterfaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkVMInterfaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkVMInterfaceRequest(val *PatchedBulkVMInterfaceRequest) *NullablePatchedBulkVMInterfaceRequest {
	return &NullablePatchedBulkVMInterfaceRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkVMInterfaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkVMInterfaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
