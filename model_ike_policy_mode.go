...
type IKEPolicyMode struct {
	Value                *BulkIKEPolicyRequestMode `json:"value,omitempty"`
...
func (o *IKEPolicyMode) GetValue() BulkIKEPolicyRequestMode {
...
func (o *IKEPolicyMode) GetValueOk() (*BulkIKEPolicyRequestMode, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkIKEPolicyRequestMode and assigns it to the Value field.
func (o *IKEPolicyMode) SetValue(v BulkIKEPolicyRequestMode) {
	o.Value = &v
}
