...
// checks if the CableBundle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CableBundle{}
...
type CableBundle struct {
	...
	CableCount           int32                  `json:"cable_count"`
	AdditionalProperties map[string]interface{}
}

type _CableBundle CableBundle
...
func (o *CableBundle) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *CableBundle) SetCreatedNil() {
	o.Created.Set(nil)
}
...
func (o *CableBundle) SetLastUpdatedNil() {
...
// GetCableCount returns the CableCount field value
...
// GetCableCountOk returns a tuple with the CableCount field value
// and a boolean to check if the value has been set.
func (o *CableBundle) GetCableCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CableCount, true
}

// SetCableCount sets field value
func (o *CableBundle) SetCableCount(v int32) {
	o.CableCount = v
}

func (o CableBundle) MarshalJSON() ([]byte, error) {
...
func (o CableBundle) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["cable_count"] = o.CableCount
...
func (o *CableBundle) UnmarshalJSON(data []byte) (err error) {
	...
	varCableBundle := _CableBundle{}

	err = json.Unmarshal(data, &varCableBundle)

	if err != nil {
		return err
	}

	*o = CableBundle(varCableBundle)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "cable_count")
...
type NullableCableBundle struct {
	value *CableBundle
	isSet bool
}

func (v NullableCableBundle) Get() *CableBundle {
	return v.value
}

func (v *NullableCableBundle) Set(val *CableBundle) {
	v.value = val
	v.isSet = true
}

func (v NullableCableBundle) IsSet() bool {
	return v.isSet
}

func (v *NullableCableBundle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCableBundle(val *CableBundle) *NullableCableBundle {
	return &NullableCableBundle{value: val, isSet: true}
}

func (v NullableCableBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCableBundle) UnmarshalJSON(src []byte) error {
	v.isSet = true
