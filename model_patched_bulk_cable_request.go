...
// checks if the PatchedBulkCableRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkCableRequest{}

// PatchedBulkCableRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkCableRequest struct {
	Id                   int32                              `json:"id"`
...
type _PatchedBulkCableRequest PatchedBulkCableRequest
...
func (o *PatchedBulkCableRequest) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *PatchedBulkCableRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkCableRequest) SetBundleNil() {
	o.Bundle.Set(nil)
}
...
func (o *PatchedBulkCableRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkCableRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedBulkCableRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PatchedBulkCableRequest) SetLengthNil() {
	o.Length.Set(nil)
}
...
func (o *PatchedBulkCableRequest) SetLengthUnitNil() {
...
func (o *PatchedBulkCableRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkCableRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkCableRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkCableRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkCableRequest := _PatchedBulkCableRequest{}

	err = json.Unmarshal(data, &varPatchedBulkCableRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkCableRequest(varPatchedBulkCableRequest)
...
type NullablePatchedBulkCableRequest struct {
	value *PatchedBulkCableRequest
	isSet bool
}

func (v NullablePatchedBulkCableRequest) Get() *PatchedBulkCableRequest {
	return v.value
}

func (v *NullablePatchedBulkCableRequest) Set(val *PatchedBulkCableRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkCableRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkCableRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkCableRequest(val *PatchedBulkCableRequest) *NullablePatchedBulkCableRequest {
	return &NullablePatchedBulkCableRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkCableRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkCableRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
