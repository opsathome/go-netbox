...
// Tenant Base serializer class for models inheriting from PrimaryModel.
type Tenant struct {
	Id                   int32                    `json:"id"`
	Url                  string                   `json:"url"`
...
func (o *Tenant) GetOwner() BriefOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Tenant) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Tenant) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *Tenant) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *Tenant) UnsetOwner() {
	o.Owner.Unset()
}
