...
type WirelessLANAuthCipher struct {
	Value                *BulkWirelessLANRequestAuthCipher `json:"value,omitempty"`
...
func (o *WirelessLANAuthCipher) GetValue() BulkWirelessLANRequestAuthCipher {
...
func (o *WirelessLANAuthCipher) GetValueOk() (*BulkWirelessLANRequestAuthCipher, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkWirelessLANRequestAuthCipher and assigns it to the Value field.
func (o *WirelessLANAuthCipher) SetValue(v BulkWirelessLANRequestAuthCipher) {
	o.Value = &v
}
