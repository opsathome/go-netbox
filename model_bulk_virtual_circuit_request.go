...
// checks if the BulkVirtualCircuitRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkVirtualCircuitRequest{}

// BulkVirtualCircuitRequest Base serializer class for models inheriting from PrimaryModel.
type BulkVirtualCircuitRequest struct {
	Id int32 `json:"id"`
	// Unique circuit ID
	Cid                  string                                    `json:"cid"`
	...
	Type                 BulkVirtualCircuitRequestType             `json:"type"`
...
type _BulkVirtualCircuitRequest BulkVirtualCircuitRequest
...
func NewBulkVirtualCircuitRequest(id int32, cid string, providerNetwork BriefVirtualCircuitRequestProviderNetwork, type_ BulkVirtualCircuitRequestType) *BulkVirtualCircuitRequest {
	this := BulkVirtualCircuitRequest{}
	this.Id = id
	this.Cid = cid
...
func (o *BulkVirtualCircuitRequest) SetProviderAccountNil() {
...
func (o *BulkVirtualCircuitRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkVirtualCircuitRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkVirtualCircuitRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkVirtualCircuitRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkVirtualCircuitRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkVirtualCircuitRequest := _BulkVirtualCircuitRequest{}

	err = json.Unmarshal(data, &varBulkVirtualCircuitRequest)

	if err != nil {
		return err
	}

	*o = BulkVirtualCircuitRequest(varBulkVirtualCircuitRequest)
...
type NullableBulkVirtualCircuitRequest struct {
	value *BulkVirtualCircuitRequest
	isSet bool
}

func (v NullableBulkVirtualCircuitRequest) Get() *BulkVirtualCircuitRequest {
	return v.value
}

func (v *NullableBulkVirtualCircuitRequest) Set(val *BulkVirtualCircuitRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkVirtualCircuitRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkVirtualCircuitRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkVirtualCircuitRequest(val *BulkVirtualCircuitRequest) *NullableBulkVirtualCircuitRequest {
	return &NullableBulkVirtualCircuitRequest{value: val, isSet: true}
}

func (v NullableBulkVirtualCircuitRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkVirtualCircuitRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
