...
func NewFHRPGroupAssignmentRequest(group BulkFHRPGroupAssignmentRequestGroup, interfaceType string, interfaceId int64, priority int32) *FHRPGroupAssignmentRequest {
...
func (o *FHRPGroupAssignmentRequest) GetGroup() BulkFHRPGroupAssignmentRequestGroup {
	if o == nil {
...
func (o *FHRPGroupAssignmentRequest) GetGroupOk() (*BulkFHRPGroupAssignmentRequestGroup, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Group, true
...
func (o *FHRPGroupAssignmentRequest) SetGroup(v BulkFHRPGroupAssignmentRequestGroup) {
	o.Group = v
}
