...
type IPSecProfileMode struct {
	Value                *BulkIPSecProfileRequestMode `json:"value,omitempty"`
...
func (o *IPSecProfileMode) GetValue() BulkIPSecProfileRequestMode {
...
func (o *IPSecProfileMode) GetValueOk() (*BulkIPSecProfileRequestMode, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkIPSecProfileRequestMode and assigns it to the Value field.
func (o *IPSecProfileMode) SetValue(v BulkIPSecProfileRequestMode) {
	o.Value = &v
}
