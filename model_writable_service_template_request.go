...
// WritableServiceTemplateRequest Base serializer class for models inheriting from PrimaryModel.
type WritableServiceTemplateRequest struct {
	Name                 string                       `json:"name"`
	Protocol             BulkServiceRequestProtocol   `json:"protocol"`
...
func NewWritableServiceTemplateRequest(name string, protocol BulkServiceRequestProtocol, ports []int32) *WritableServiceTemplateRequest {
