...
// PatchedWritableCustomFieldRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritableCustomFieldRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
