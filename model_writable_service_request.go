...
func NewWritableServiceRequest(parentObjectType string, parentObjectId int64, name string, protocol BulkServiceRequestProtocol, ports []int32) *WritableServiceRequest {
