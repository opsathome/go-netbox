...
type Rack struct {
	...
	Group      NullableBriefRackGroup `json:"group,omitempty"`
...
// SetGroup gets a reference to the given NullableBriefRackGroup and assigns it to the Group field.
