...
// checks if the PatchedBulkSiteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkSiteRequest{}

// PatchedBulkSiteRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkSiteRequest struct {
	Id int32 `json:"id"`
...
type _PatchedBulkSiteRequest PatchedBulkSiteRequest
...
func (o *PatchedBulkSiteRequest) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetTimeZoneNil() {
	o.TimeZone.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetLatitudeNil() {
	o.Latitude.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetLongitudeNil() {
	o.Longitude.Set(nil)
}
...
func (o *PatchedBulkSiteRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkSiteRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkSiteRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkSiteRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkSiteRequest := _PatchedBulkSiteRequest{}

	err = json.Unmarshal(data, &varPatchedBulkSiteRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkSiteRequest(varPatchedBulkSiteRequest)
...
type NullablePatchedBulkSiteRequest struct {
	value *PatchedBulkSiteRequest
	isSet bool
}

func (v NullablePatchedBulkSiteRequest) Get() *PatchedBulkSiteRequest {
	return v.value
}

func (v *NullablePatchedBulkSiteRequest) Set(val *PatchedBulkSiteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkSiteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkSiteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkSiteRequest(val *PatchedBulkSiteRequest) *NullablePatchedBulkSiteRequest {
	return &NullablePatchedBulkSiteRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkSiteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkSiteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
