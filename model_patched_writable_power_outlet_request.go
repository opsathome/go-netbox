...
// PatchedWritablePowerOutletRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritablePowerOutletRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritablePowerOutletRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedWritablePowerOutletRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PatchedWritablePowerOutletRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
