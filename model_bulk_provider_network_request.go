...
// checks if the BulkProviderNetworkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkProviderNetworkRequest{}

// BulkProviderNetworkRequest Base serializer class for models inheriting from PrimaryModel.
type BulkProviderNetworkRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkProviderNetworkRequest BulkProviderNetworkRequest
...
func NewBulkProviderNetworkRequest(id int32, provider BriefCircuitRequestProvider, name string) *BulkProviderNetworkRequest {
	this := BulkProviderNetworkRequest{}
	this.Id = id
...
func (o *BulkProviderNetworkRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkProviderNetworkRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkProviderNetworkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkProviderNetworkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkProviderNetworkRequest := _BulkProviderNetworkRequest{}

	err = json.Unmarshal(data, &varBulkProviderNetworkRequest)

	if err != nil {
		return err
	}

	*o = BulkProviderNetworkRequest(varBulkProviderNetworkRequest)
...
type NullableBulkProviderNetworkRequest struct {
	value *BulkProviderNetworkRequest
	isSet bool
}

func (v NullableBulkProviderNetworkRequest) Get() *BulkProviderNetworkRequest {
	return v.value
}

func (v *NullableBulkProviderNetworkRequest) Set(val *BulkProviderNetworkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkProviderNetworkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkProviderNetworkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkProviderNetworkRequest(val *BulkProviderNetworkRequest) *NullableBulkProviderNetworkRequest {
	return &NullableBulkProviderNetworkRequest{value: val, isSet: true}
}

func (v NullableBulkProviderNetworkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkProviderNetworkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
