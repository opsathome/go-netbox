...
func (dst *BriefInterfaceRequestDevice) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefInterfaceRequestDevice): %v", err)
		} else {
...
func (obj BriefInterfaceRequestDevice) GetActualInstanceValue() interface{} {
	if obj.BriefDeviceRequest != nil {
		return *obj.BriefDeviceRequest
	}
