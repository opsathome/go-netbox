...
type InterfaceTemplatePoeMode struct {
	Value                *BulkInterfaceRequestPoeMode `json:"value,omitempty"`
...
func (o *InterfaceTemplatePoeMode) GetValue() BulkInterfaceRequestPoeMode {
...
func (o *InterfaceTemplatePoeMode) GetValueOk() (*BulkInterfaceRequestPoeMode, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestPoeMode and assigns it to the Value field.
func (o *InterfaceTemplatePoeMode) SetValue(v BulkInterfaceRequestPoeMode) {
	o.Value = &v
}
