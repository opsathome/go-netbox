...
type ConsolePortType struct {
	Value                *BulkConsolePortRequestType `json:"value,omitempty"`
...
func (o *ConsolePortType) GetValue() BulkConsolePortRequestType {
...
func (o *ConsolePortType) GetValueOk() (*BulkConsolePortRequestType, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkConsolePortRequestType and assigns it to the Value field.
func (o *ConsolePortType) SetValue(v BulkConsolePortRequestType) {
	o.Value = &v
}
