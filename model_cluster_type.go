...
// ClusterType Base serializer class for models inheriting from OrganizationalModel.
...
func (o *ClusterType) GetOwner() BriefOwner {
...
func (o *ClusterType) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClusterType) HasOwner() bool {
...
func (o *ClusterType) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *ClusterType) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *ClusterType) UnsetOwner() {
	o.Owner.Unset()
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *ClusterType) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *ClusterType) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *ClusterType) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
...
func (o *ClusterType) SetComments(v string) {
	o.Comments = &v
}
