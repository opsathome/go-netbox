...
// checks if the BulkRouteTargetRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkRouteTargetRequest{}

// BulkRouteTargetRequest Base serializer class for models inheriting from PrimaryModel.
type BulkRouteTargetRequest struct {
	Id int32 `json:"id"`
...
type _BulkRouteTargetRequest BulkRouteTargetRequest
...
func (o *BulkRouteTargetRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkRouteTargetRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkRouteTargetRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkRouteTargetRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkRouteTargetRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkRouteTargetRequest := _BulkRouteTargetRequest{}

	err = json.Unmarshal(data, &varBulkRouteTargetRequest)

	if err != nil {
		return err
	}

	*o = BulkRouteTargetRequest(varBulkRouteTargetRequest)
...
type NullableBulkRouteTargetRequest struct {
	value *BulkRouteTargetRequest
	isSet bool
}

func (v NullableBulkRouteTargetRequest) Get() *BulkRouteTargetRequest {
	return v.value
}

func (v *NullableBulkRouteTargetRequest) Set(val *BulkRouteTargetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkRouteTargetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkRouteTargetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkRouteTargetRequest(val *BulkRouteTargetRequest) *NullableBulkRouteTargetRequest {
	return &NullableBulkRouteTargetRequest{value: val, isSet: true}
}

func (v NullableBulkRouteTargetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkRouteTargetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
