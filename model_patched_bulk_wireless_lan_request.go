...
// checks if the PatchedBulkWirelessLANRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWirelessLANRequest{}

// PatchedBulkWirelessLANRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkWirelessLANRequest struct {
	Id                   int32                                    `json:"id"`
...
type _PatchedBulkWirelessLANRequest PatchedBulkWirelessLANRequest
...
func NewPatchedBulkWirelessLANRequest(id int32) *PatchedBulkWirelessLANRequest {
	this := PatchedBulkWirelessLANRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkWirelessLANRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *PatchedBulkWirelessLANRequest) SetVlanNil() {
	o.Vlan.Set(nil)
}
...
func (o *PatchedBulkWirelessLANRequest) SetScopeTypeNil() {
	o.ScopeType.Set(nil)
}
...
func (o *PatchedBulkWirelessLANRequest) SetScopeIdNil() {
	o.ScopeId.Set(nil)
}
...
func (o *PatchedBulkWirelessLANRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkWirelessLANRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkWirelessLANRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWirelessLANRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWirelessLANRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWirelessLANRequest := _PatchedBulkWirelessLANRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWirelessLANRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWirelessLANRequest(varPatchedBulkWirelessLANRequest)
...
type NullablePatchedBulkWirelessLANRequest struct {
	value *PatchedBulkWirelessLANRequest
	isSet bool
}

func (v NullablePatchedBulkWirelessLANRequest) Get() *PatchedBulkWirelessLANRequest {
	return v.value
}

func (v *NullablePatchedBulkWirelessLANRequest) Set(val *PatchedBulkWirelessLANRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWirelessLANRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWirelessLANRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWirelessLANRequest(val *PatchedBulkWirelessLANRequest) *NullablePatchedBulkWirelessLANRequest {
	return &NullablePatchedBulkWirelessLANRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWirelessLANRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWirelessLANRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
