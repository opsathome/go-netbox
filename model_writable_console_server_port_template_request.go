...
func (o *WritableConsoleServerPortTemplateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType {
...
func (o *WritableConsoleServerPortTemplateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableConsoleServerPortTemplateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType) {
	o.DeviceType.Set(&v)
}
...
func (o *WritableConsoleServerPortTemplateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableConsoleServerPortTemplateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableConsoleServerPortTemplateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType) {
	o.ModuleType.Set(&v)
}
