...
type DeviceStatus struct {
	Value                *BulkDeviceWithConfigContextRequestStatus `json:"value,omitempty"`
...
func (o *DeviceStatus) GetValue() BulkDeviceWithConfigContextRequestStatus {
...
func (o *DeviceStatus) GetValueOk() (*BulkDeviceWithConfigContextRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkDeviceWithConfigContextRequestStatus and assigns it to the Value field.
func (o *DeviceStatus) SetValue(v BulkDeviceWithConfigContextRequestStatus) {
	o.Value = &v
}
