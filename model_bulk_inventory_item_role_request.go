...
// checks if the BulkInventoryItemRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkInventoryItemRoleRequest{}

// BulkInventoryItemRoleRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkInventoryItemRoleRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkInventoryItemRoleRequest BulkInventoryItemRoleRequest
...
func NewBulkInventoryItemRoleRequest(id int32, name string, slug string) *BulkInventoryItemRoleRequest {
	this := BulkInventoryItemRoleRequest{}
	this.Id = id
	this.Name = name
	this.Slug = slug
	return &this
...
func (o *BulkInventoryItemRoleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkInventoryItemRoleRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkInventoryItemRoleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkInventoryItemRoleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkInventoryItemRoleRequest := _BulkInventoryItemRoleRequest{}

	err = json.Unmarshal(data, &varBulkInventoryItemRoleRequest)

	if err != nil {
		return err
	}

	*o = BulkInventoryItemRoleRequest(varBulkInventoryItemRoleRequest)
...
type NullableBulkInventoryItemRoleRequest struct {
	value *BulkInventoryItemRoleRequest
	isSet bool
}

func (v NullableBulkInventoryItemRoleRequest) Get() *BulkInventoryItemRoleRequest {
	return v.value
}

func (v *NullableBulkInventoryItemRoleRequest) Set(val *BulkInventoryItemRoleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkInventoryItemRoleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkInventoryItemRoleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkInventoryItemRoleRequest(val *BulkInventoryItemRoleRequest) *NullableBulkInventoryItemRoleRequest {
	return &NullableBulkInventoryItemRoleRequest{value: val, isSet: true}
}

func (v NullableBulkInventoryItemRoleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkInventoryItemRoleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
