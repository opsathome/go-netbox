...
// RouteTargetRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *RouteTargetRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RouteTargetRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RouteTargetRequest) HasOwner() bool {
...
func (o *RouteTargetRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *RouteTargetRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *RouteTargetRequest) UnsetOwner() {
	o.Owner.Unset()
}
