...
// VLANGroup Base serializer class for models inheriting from OrganizationalModel.
type VLANGroup struct {
	...
	TotalVlanIds         int32                  `json:"total_vlan_ids"`
...
func NewVLANGroup(id int32, url string, display string, name string, slug string, totalVlanIds int32, utilization string) *VLANGroup {
	this := VLANGroup{}
	this.Id = id
	this.Url = url
	...
	this.Name = name
	this.Slug = slug
	this.TotalVlanIds = totalVlanIds
...
// GetTotalVlanIds returns the TotalVlanIds field value
func (o *VLANGroup) GetTotalVlanIds() int32 {
	...
	return o.TotalVlanIds
}

// GetTotalVlanIdsOk returns a tuple with the TotalVlanIds field value
// and a boolean to check if the value has been set.
func (o *VLANGroup) GetTotalVlanIdsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalVlanIds, true
}

// SetTotalVlanIds sets field value
...
func (o VLANGroup) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["total_vlan_ids"] = o.TotalVlanIds
	if o.Tenant.IsSet() {
...
func (o *VLANGroup) UnmarshalJSON(data []byte) (err error) {
	...
	*o = VLANGroup(varVLANGroup)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "total_vlan_ids")
