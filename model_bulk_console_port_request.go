...
// checks if the BulkConsolePortRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkConsolePortRequest{}

// BulkConsolePortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkConsolePortRequest struct {
	Id     int32                                `json:"id"`
...
type _BulkConsolePortRequest BulkConsolePortRequest

// NewBulkConsolePortRequest instantiates a new BulkConsolePortRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkConsolePortRequest(id int32, device BriefInterfaceRequestDevice, name string) *BulkConsolePortRequest {
	this := BulkConsolePortRequest{}
	this.Id = id
	this.Device = device
	this.Name = name
	return &this
...
func (o *BulkConsolePortRequest) GetDevice() BriefInterfaceRequestDevice {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkConsolePortRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkConsolePortRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = v
}
...
func (o *BulkConsolePortRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *BulkConsolePortRequest) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
func (o *BulkConsolePortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkConsolePortRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkConsolePortRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkConsolePortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkConsolePortRequest := _BulkConsolePortRequest{}

	err = json.Unmarshal(data, &varBulkConsolePortRequest)

	if err != nil {
		return err
	}

	*o = BulkConsolePortRequest(varBulkConsolePortRequest)
...
type NullableBulkConsolePortRequest struct {
	value *BulkConsolePortRequest
	isSet bool
}

func (v NullableBulkConsolePortRequest) Get() *BulkConsolePortRequest {
	return v.value
}

func (v *NullableBulkConsolePortRequest) Set(val *BulkConsolePortRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkConsolePortRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkConsolePortRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkConsolePortRequest(val *BulkConsolePortRequest) *NullableBulkConsolePortRequest {
	return &NullableBulkConsolePortRequest{value: val, isSet: true}
}

func (v NullableBulkConsolePortRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkConsolePortRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
