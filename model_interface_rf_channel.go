...
type InterfaceRfChannel struct {
	Value                *BulkInterfaceRequestRfChannel `json:"value,omitempty"`
...
func (o *InterfaceRfChannel) GetValue() BulkInterfaceRequestRfChannel {
...
func (o *InterfaceRfChannel) GetValueOk() (*BulkInterfaceRequestRfChannel, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestRfChannel and assigns it to the Value field.
func (o *InterfaceRfChannel) SetValue(v BulkInterfaceRequestRfChannel) {
	o.Value = &v
}
