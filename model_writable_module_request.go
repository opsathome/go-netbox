...
// WritableModuleRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewWritableModuleRequest(device BriefInterfaceRequestDevice, moduleBay int32, moduleType BulkModuleRequestModuleType) *WritableModuleRequest {
...
func (o *WritableModuleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
