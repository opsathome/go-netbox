...
func (o *PatchedConfigContextProfileRequest) GetDataSource() BulkConfigContextProfileRequestDataSource {
...
// and a boolean to check if the value has been set.
func (o *PatchedConfigContextProfileRequest) GetDataSourceOk() (*BulkConfigContextProfileRequestDataSource, bool) {
	if o == nil || IsNil(o.DataSource) {
		return nil, false
	}
...
func (o *PatchedConfigContextProfileRequest) SetDataSource(v BulkConfigContextProfileRequestDataSource) {
	o.DataSource = &v
}
