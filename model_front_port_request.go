...
func NewFrontPortRequest(device BriefInterfaceRequestDevice, name string, type_ BulkFrontPortRequestType) *FrontPortRequest {
...
func (o *FrontPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *FrontPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *FrontPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
