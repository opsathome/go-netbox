...
// checks if the BulkRIRRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkRIRRequest{}

// BulkRIRRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkRIRRequest struct {
	Id   int32  `json:"id"`
...
type _BulkRIRRequest BulkRIRRequest
...
func (o *BulkRIRRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkRIRRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkRIRRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkRIRRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkRIRRequest := _BulkRIRRequest{}

	err = json.Unmarshal(data, &varBulkRIRRequest)

	if err != nil {
		return err
	}

	*o = BulkRIRRequest(varBulkRIRRequest)
...
type NullableBulkRIRRequest struct {
	value *BulkRIRRequest
	isSet bool
}

func (v NullableBulkRIRRequest) Get() *BulkRIRRequest {
	return v.value
}

func (v *NullableBulkRIRRequest) Set(val *BulkRIRRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkRIRRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkRIRRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkRIRRequest(val *BulkRIRRequest) *NullableBulkRIRRequest {
	return &NullableBulkRIRRequest{value: val, isSet: true}
}

func (v NullableBulkRIRRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkRIRRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
