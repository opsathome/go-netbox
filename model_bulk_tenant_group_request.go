...
// checks if the BulkTenantGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkTenantGroupRequest{}

// BulkTenantGroupRequest Base serializer class for models inheriting from NestedGroupModel.
type BulkTenantGroupRequest struct {
	Id                   int32                            `json:"id"`
...
type _BulkTenantGroupRequest BulkTenantGroupRequest
...
func (o *BulkTenantGroupRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkTenantGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkTenantGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkTenantGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkTenantGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkTenantGroupRequest := _BulkTenantGroupRequest{}

	err = json.Unmarshal(data, &varBulkTenantGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkTenantGroupRequest(varBulkTenantGroupRequest)
...
type NullableBulkTenantGroupRequest struct {
	value *BulkTenantGroupRequest
	isSet bool
}

func (v NullableBulkTenantGroupRequest) Get() *BulkTenantGroupRequest {
	return v.value
}

func (v *NullableBulkTenantGroupRequest) Set(val *BulkTenantGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkTenantGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkTenantGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkTenantGroupRequest(val *BulkTenantGroupRequest) *NullableBulkTenantGroupRequest {
	return &NullableBulkTenantGroupRequest{value: val, isSet: true}
}

func (v NullableBulkTenantGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkTenantGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
