...
type TunnelEncapsulation struct {
	Value                *BulkTunnelRequestEncapsulation `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkTunnelRequestEncapsulation and assigns it to the Value field.
