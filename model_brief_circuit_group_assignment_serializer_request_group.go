...
func (dst *BriefCircuitGroupAssignmentSerializerRequestGroup) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefCircuitGroupAssignmentSerializerRequestGroup): %v", err)
		} else {
...
func (obj BriefCircuitGroupAssignmentSerializerRequestGroup) GetActualInstanceValue() interface{} {
	if obj.BriefCircuitGroupRequest != nil {
		return *obj.BriefCircuitGroupRequest
	}
