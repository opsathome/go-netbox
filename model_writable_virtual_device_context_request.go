...
func NewWritableVirtualDeviceContextRequest(name string, device BriefInterfaceRequestDevice, status BulkVirtualDeviceContextRequestStatus) *WritableVirtualDeviceContextRequest {
...
func (o *WritableVirtualDeviceContextRequest) GetPrimaryIp4() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableVirtualDeviceContextRequest) GetPrimaryIp4Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVirtualDeviceContextRequest) SetPrimaryIp4(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp4.Set(&v)
}
...
func (o *WritableVirtualDeviceContextRequest) GetPrimaryIp6() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableVirtualDeviceContextRequest) GetPrimaryIp6Ok() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVirtualDeviceContextRequest) SetPrimaryIp6(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.PrimaryIp6.Set(&v)
}
...
func (o *WritableVirtualDeviceContextRequest) GetStatus() BulkVirtualDeviceContextRequestStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WritableVirtualDeviceContextRequest) GetStatusOk() (*BulkVirtualDeviceContextRequestStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableVirtualDeviceContextRequest) SetStatus(v BulkVirtualDeviceContextRequestStatus) {
	o.Status = v
}
