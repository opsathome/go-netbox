...
// checks if the PatchedBulkVirtualMachineTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkVirtualMachineTypeRequest{}

// PatchedBulkVirtualMachineTypeRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkVirtualMachineTypeRequest struct {
	Id                   int32                                        `json:"id"`
...
type _PatchedBulkVirtualMachineTypeRequest PatchedBulkVirtualMachineTypeRequest
...
func NewPatchedBulkVirtualMachineTypeRequest(id int32) *PatchedBulkVirtualMachineTypeRequest {
	this := PatchedBulkVirtualMachineTypeRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkVirtualMachineTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *PatchedBulkVirtualMachineTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkVirtualMachineTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
	o.DefaultPlatform.Set(&v)
}

// SetDefaultPlatformNil sets the value for DefaultPlatform to be an explicit nil
func (o *PatchedBulkVirtualMachineTypeRequest) SetDefaultPlatformNil() {
...
func (o *PatchedBulkVirtualMachineTypeRequest) SetDefaultVcpusNil() {
...
func (o *PatchedBulkVirtualMachineTypeRequest) SetDefaultMemoryNil() {
...
func (o *PatchedBulkVirtualMachineTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkVirtualMachineTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkVirtualMachineTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkVirtualMachineTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkVirtualMachineTypeRequest := _PatchedBulkVirtualMachineTypeRequest{}

	err = json.Unmarshal(data, &varPatchedBulkVirtualMachineTypeRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkVirtualMachineTypeRequest(varPatchedBulkVirtualMachineTypeRequest)
...
type NullablePatchedBulkVirtualMachineTypeRequest struct {
	value *PatchedBulkVirtualMachineTypeRequest
	isSet bool
}

func (v NullablePatchedBulkVirtualMachineTypeRequest) Get() *PatchedBulkVirtualMachineTypeRequest {
	return v.value
}

func (v *NullablePatchedBulkVirtualMachineTypeRequest) Set(val *PatchedBulkVirtualMachineTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkVirtualMachineTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkVirtualMachineTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkVirtualMachineTypeRequest(val *PatchedBulkVirtualMachineTypeRequest) *NullablePatchedBulkVirtualMachineTypeRequest {
	return &NullablePatchedBulkVirtualMachineTypeRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkVirtualMachineTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkVirtualMachineTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
