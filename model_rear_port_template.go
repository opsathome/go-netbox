...
type RearPortTemplate struct {
	...
	FrontPorts           []RearPortTemplateMapping `json:"front_ports,omitempty"`
...
func (o *RearPortTemplate) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *RearPortTemplate) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *RearPortTemplate) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *RearPortTemplate) GetFrontPorts() []RearPortTemplateMapping {
	if o == nil || IsNil(o.FrontPorts) {
		var ret []RearPortTemplateMapping
		return ret
	}
	return o.FrontPorts
}
...
// SetFrontPorts gets a reference to the given []RearPortTemplateMapping and assigns it to the FrontPorts field.
