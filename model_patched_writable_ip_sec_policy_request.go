...
// PatchedWritableIPSecPolicyRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PatchedWritableIPSecPolicyRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableIPSecPolicyRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableIPSecPolicyRequest) HasOwner() bool {
...
func (o *PatchedWritableIPSecPolicyRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedWritableIPSecPolicyRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *PatchedWritableIPSecPolicyRequest) UnsetOwner() {
	o.Owner.Unset()
}
