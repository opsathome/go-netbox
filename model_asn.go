...
type ASN struct {
	...
	Sites                []ASNSite              `json:"sites,omitempty"`
...
// SetSites gets a reference to the given []ASNSite and assigns it to the Sites field.
