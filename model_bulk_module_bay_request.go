...
// checks if the BulkModuleBayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkModuleBayRequest{}

// BulkModuleBayRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkModuleBayRequest struct {
	Id     int32                                `json:"id"`
...
type _BulkModuleBayRequest BulkModuleBayRequest

// NewBulkModuleBayRequest instantiates a new BulkModuleBayRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkModuleBayRequest(id int32, device BriefInterfaceRequestDevice, name string) *BulkModuleBayRequest {
	this := BulkModuleBayRequest{}
	this.Id = id
	this.Device = device
	this.Name = name
	return &this
...
func (o *BulkModuleBayRequest) GetDevice() BriefInterfaceRequestDevice {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkModuleBayRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkModuleBayRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = v
}
...
func (o *BulkModuleBayRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *BulkModuleBayRequest) SetInstalledModuleNil() {
...
func (o *BulkModuleBayRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkModuleBayRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkModuleBayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkModuleBayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkModuleBayRequest := _BulkModuleBayRequest{}

	err = json.Unmarshal(data, &varBulkModuleBayRequest)

	if err != nil {
		return err
	}

	*o = BulkModuleBayRequest(varBulkModuleBayRequest)
...
type NullableBulkModuleBayRequest struct {
	value *BulkModuleBayRequest
	isSet bool
}

func (v NullableBulkModuleBayRequest) Get() *BulkModuleBayRequest {
	return v.value
}

func (v *NullableBulkModuleBayRequest) Set(val *BulkModuleBayRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkModuleBayRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkModuleBayRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkModuleBayRequest(val *BulkModuleBayRequest) *NullableBulkModuleBayRequest {
	return &NullableBulkModuleBayRequest{value: val, isSet: true}
}

func (v NullableBulkModuleBayRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkModuleBayRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
