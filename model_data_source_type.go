...
type DataSourceType struct {
	Value                *BulkDataSourceRequestType `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkDataSourceRequestType and assigns it to the Value field.
