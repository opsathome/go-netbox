...
// RackGroup Base serializer class for models inheriting from OrganizationalModel.
...
func (o *RackGroup) SetCreatedNil() {
	o.Created.Set(nil)
}
...
func (o *RackGroup) SetLastUpdatedNil() {
