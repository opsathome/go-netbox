...
// checks if the PatchedBulkModuleBayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkModuleBayRequest{}

// PatchedBulkModuleBayRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkModuleBayRequest struct {
	Id     int32                                `json:"id"`
	...
	InstalledModule      NullableBulkConsolePortRequestModule `json:"installed_module,omitempty"`
...
type _PatchedBulkModuleBayRequest PatchedBulkModuleBayRequest
...
func NewPatchedBulkModuleBayRequest(id int32) *PatchedBulkModuleBayRequest {
	this := PatchedBulkModuleBayRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkModuleBayRequest) GetDevice() BriefInterfaceRequestDevice {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkModuleBayRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil || IsNil(o.Device) {
		return nil, false
	}
...
func (o *PatchedBulkModuleBayRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = &v
}
...
func (o *PatchedBulkModuleBayRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
// SetInstalledModule gets a reference to the given NullableBulkConsolePortRequestModule and assigns it to the InstalledModule field.
...
func (o *PatchedBulkModuleBayRequest) SetInstalledModuleNil() {
...
func (o *PatchedBulkModuleBayRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkModuleBayRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkModuleBayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkModuleBayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkModuleBayRequest := _PatchedBulkModuleBayRequest{}

	err = json.Unmarshal(data, &varPatchedBulkModuleBayRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkModuleBayRequest(varPatchedBulkModuleBayRequest)
...
type NullablePatchedBulkModuleBayRequest struct {
	value *PatchedBulkModuleBayRequest
	isSet bool
}

func (v NullablePatchedBulkModuleBayRequest) Get() *PatchedBulkModuleBayRequest {
	return v.value
}

func (v *NullablePatchedBulkModuleBayRequest) Set(val *PatchedBulkModuleBayRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkModuleBayRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkModuleBayRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkModuleBayRequest(val *PatchedBulkModuleBayRequest) *NullablePatchedBulkModuleBayRequest {
	return &NullablePatchedBulkModuleBayRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkModuleBayRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkModuleBayRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
