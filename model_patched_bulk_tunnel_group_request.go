...
// checks if the PatchedBulkTunnelGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkTunnelGroupRequest{}

// PatchedBulkTunnelGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type PatchedBulkTunnelGroupRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkTunnelGroupRequest PatchedBulkTunnelGroupRequest
...
func NewPatchedBulkTunnelGroupRequest(id int32) *PatchedBulkTunnelGroupRequest {
	this := PatchedBulkTunnelGroupRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkTunnelGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkTunnelGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkTunnelGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkTunnelGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkTunnelGroupRequest := _PatchedBulkTunnelGroupRequest{}

	err = json.Unmarshal(data, &varPatchedBulkTunnelGroupRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkTunnelGroupRequest(varPatchedBulkTunnelGroupRequest)
...
type NullablePatchedBulkTunnelGroupRequest struct {
	value *PatchedBulkTunnelGroupRequest
	isSet bool
}

func (v NullablePatchedBulkTunnelGroupRequest) Get() *PatchedBulkTunnelGroupRequest {
	return v.value
}

func (v *NullablePatchedBulkTunnelGroupRequest) Set(val *PatchedBulkTunnelGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkTunnelGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkTunnelGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkTunnelGroupRequest(val *PatchedBulkTunnelGroupRequest) *NullablePatchedBulkTunnelGroupRequest {
	return &NullablePatchedBulkTunnelGroupRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkTunnelGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkTunnelGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
