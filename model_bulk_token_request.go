...
// checks if the BulkTokenRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkTokenRequest{}

// BulkTokenRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
...
type _BulkTokenRequest BulkTokenRequest
...
func (o *BulkTokenRequest) SetExpiresNil() {
	o.Expires.Set(nil)
}
...
func (o *BulkTokenRequest) SetLastUsedNil() {
	o.LastUsed.Set(nil)
}
...
func (o *BulkTokenRequest) SetPepperIdNil() {
	o.PepperId.Set(nil)
}
...
func (o *BulkTokenRequest) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *BulkTokenRequest) GetTokenOk() (*string, bool) {
	if o == nil || IsNil(o.Token) {
		return nil, false
	}
	return o.Token, true
...
func (o *BulkTokenRequest) HasToken() bool {
	if o != nil && !IsNil(o.Token) {
		return true
	}
...
func (o *BulkTokenRequest) SetToken(v string) {
	o.Token = &v
}

func (o BulkTokenRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkTokenRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkTokenRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkTokenRequest := _BulkTokenRequest{}

	err = json.Unmarshal(data, &varBulkTokenRequest)

	if err != nil {
		return err
	}

	*o = BulkTokenRequest(varBulkTokenRequest)
...
type NullableBulkTokenRequest struct {
	value *BulkTokenRequest
	isSet bool
}

func (v NullableBulkTokenRequest) Get() *BulkTokenRequest {
	return v.value
}

func (v *NullableBulkTokenRequest) Set(val *BulkTokenRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkTokenRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkTokenRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkTokenRequest(val *BulkTokenRequest) *NullableBulkTokenRequest {
	return &NullableBulkTokenRequest{value: val, isSet: true}
}

func (v NullableBulkTokenRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkTokenRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
