...
// checks if the PatchedBulkRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkRoleRequest{}

// PatchedBulkRoleRequest Base serializer class for models inheriting from OrganizationalModel.
type PatchedBulkRoleRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkRoleRequest PatchedBulkRoleRequest
...
func (o *PatchedBulkRoleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkRoleRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkRoleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkRoleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkRoleRequest := _PatchedBulkRoleRequest{}

	err = json.Unmarshal(data, &varPatchedBulkRoleRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkRoleRequest(varPatchedBulkRoleRequest)
...
type NullablePatchedBulkRoleRequest struct {
	value *PatchedBulkRoleRequest
	isSet bool
}

func (v NullablePatchedBulkRoleRequest) Get() *PatchedBulkRoleRequest {
	return v.value
}

func (v *NullablePatchedBulkRoleRequest) Set(val *PatchedBulkRoleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkRoleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkRoleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkRoleRequest(val *PatchedBulkRoleRequest) *NullablePatchedBulkRoleRequest {
	return &NullablePatchedBulkRoleRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkRoleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkRoleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
