...
// ProviderRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *ProviderRequest) GetOwner() ASNRangeRequestOwner {
...
func (o *ProviderRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProviderRequest) HasOwner() bool {
...
func (o *ProviderRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *ProviderRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *ProviderRequest) UnsetOwner() {
	o.Owner.Unset()
}
