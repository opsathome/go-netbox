...
// RearPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func NewRearPortRequest(device BriefInterfaceRequestDevice, name string, type_ BulkFrontPortRequestType) *RearPortRequest {
...
func (o *RearPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *RearPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *RearPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *RearPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
