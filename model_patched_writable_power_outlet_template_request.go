...
func (o *PatchedWritablePowerOutletTemplateRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritablePowerOutletTemplateRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedWritablePowerOutletTemplateRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
