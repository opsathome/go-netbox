...
type DeviceFace struct {
	Value                *BulkDeviceWithConfigContextRequestFace `json:"value,omitempty"`
...
func (o *DeviceFace) GetValue() BulkDeviceWithConfigContextRequestFace {
...
func (o *DeviceFace) GetValueOk() (*BulkDeviceWithConfigContextRequestFace, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkDeviceWithConfigContextRequestFace and assigns it to the Value field.
func (o *DeviceFace) SetValue(v BulkDeviceWithConfigContextRequestFace) {
	o.Value = &v
}
