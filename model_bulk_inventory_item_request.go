...
// checks if the BulkInventoryItemRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkInventoryItemRequest{}

// BulkInventoryItemRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkInventoryItemRequest struct {
	Id     int32                       `json:"id"`
...
type _BulkInventoryItemRequest BulkInventoryItemRequest

// NewBulkInventoryItemRequest instantiates a new BulkInventoryItemRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkInventoryItemRequest(id int32, device BriefInterfaceRequestDevice, name string) *BulkInventoryItemRequest {
	this := BulkInventoryItemRequest{}
	this.Id = id
	this.Device = device
	this.Name = name
	return &this
...
func (o *BulkInventoryItemRequest) GetDevice() BriefInterfaceRequestDevice {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkInventoryItemRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkInventoryItemRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = v
}
...
func (o *BulkInventoryItemRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkInventoryItemRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *BulkInventoryItemRequest) SetManufacturerNil() {
...
func (o *BulkInventoryItemRequest) SetAssetTagNil() {
	o.AssetTag.Set(nil)
}
...
func (o *BulkInventoryItemRequest) SetComponentTypeNil() {
...
func (o *BulkInventoryItemRequest) SetComponentIdNil() {
...
func (o *BulkInventoryItemRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkInventoryItemRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkInventoryItemRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkInventoryItemRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkInventoryItemRequest := _BulkInventoryItemRequest{}

	err = json.Unmarshal(data, &varBulkInventoryItemRequest)

	if err != nil {
		return err
	}

	*o = BulkInventoryItemRequest(varBulkInventoryItemRequest)
...
type NullableBulkInventoryItemRequest struct {
	value *BulkInventoryItemRequest
	isSet bool
}

func (v NullableBulkInventoryItemRequest) Get() *BulkInventoryItemRequest {
	return v.value
}

func (v *NullableBulkInventoryItemRequest) Set(val *BulkInventoryItemRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkInventoryItemRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkInventoryItemRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkInventoryItemRequest(val *BulkInventoryItemRequest) *NullableBulkInventoryItemRequest {
	return &NullableBulkInventoryItemRequest{value: val, isSet: true}
}

func (v NullableBulkInventoryItemRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkInventoryItemRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
