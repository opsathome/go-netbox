...
type Cable struct {
	...
	Bundle               NullableBriefCableBundle     `json:"bundle,omitempty"`
...
// SetProfile gets a reference to the given CableProfile and assigns it to the Profile field.
...
// SetBundle gets a reference to the given NullableBriefCableBundle and assigns it to the Bundle field.
func (o *Cable) SetBundle(v BriefCableBundle) {
	o.Bundle.Set(&v)
}

// SetBundleNil sets the value for Bundle to be an explicit nil
func (o *Cable) SetBundleNil() {
	o.Bundle.Set(nil)
}
...
func (o *Cable) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *Cable) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *Cable) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
