...
// checks if the BulkCircuitGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkCircuitGroupRequest{}

// BulkCircuitGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkCircuitGroupRequest struct {
	Id                   int32                         `json:"id"`
...
type _BulkCircuitGroupRequest BulkCircuitGroupRequest
...
func (o *BulkCircuitGroupRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkCircuitGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkCircuitGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkCircuitGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkCircuitGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkCircuitGroupRequest := _BulkCircuitGroupRequest{}

	err = json.Unmarshal(data, &varBulkCircuitGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkCircuitGroupRequest(varBulkCircuitGroupRequest)
...
type NullableBulkCircuitGroupRequest struct {
	value *BulkCircuitGroupRequest
	isSet bool
}

func (v NullableBulkCircuitGroupRequest) Get() *BulkCircuitGroupRequest {
	return v.value
}

func (v *NullableBulkCircuitGroupRequest) Set(val *BulkCircuitGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkCircuitGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkCircuitGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkCircuitGroupRequest(val *BulkCircuitGroupRequest) *NullableBulkCircuitGroupRequest {
	return &NullableBulkCircuitGroupRequest{value: val, isSet: true}
}

func (v NullableBulkCircuitGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkCircuitGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
