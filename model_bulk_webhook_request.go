...
// checks if the BulkWebhookRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWebhookRequest{}

// BulkWebhookRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
type _BulkWebhookRequest BulkWebhookRequest
...
func (o *BulkWebhookRequest) SetCaFilePathNil() {
...
func (o *BulkWebhookRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkWebhookRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWebhookRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWebhookRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWebhookRequest := _BulkWebhookRequest{}

	err = json.Unmarshal(data, &varBulkWebhookRequest)

	if err != nil {
		return err
	}

	*o = BulkWebhookRequest(varBulkWebhookRequest)
...
type NullableBulkWebhookRequest struct {
	value *BulkWebhookRequest
	isSet bool
}

func (v NullableBulkWebhookRequest) Get() *BulkWebhookRequest {
	return v.value
}

func (v *NullableBulkWebhookRequest) Set(val *BulkWebhookRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWebhookRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWebhookRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWebhookRequest(val *BulkWebhookRequest) *NullableBulkWebhookRequest {
	return &NullableBulkWebhookRequest{value: val, isSet: true}
}

func (v NullableBulkWebhookRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWebhookRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
