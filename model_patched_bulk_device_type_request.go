...
// checks if the PatchedBulkDeviceTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkDeviceTypeRequest{}

// PatchedBulkDeviceTypeRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkDeviceTypeRequest struct {
	Id              int32                                        `json:"id"`
	...
	SubdeviceRole        NullableBulkDeviceTypeRequestSubdeviceRole `json:"subdevice_role,omitempty"`
...
type _PatchedBulkDeviceTypeRequest PatchedBulkDeviceTypeRequest
...
func NewPatchedBulkDeviceTypeRequest(id int32) *PatchedBulkDeviceTypeRequest {
	this := PatchedBulkDeviceTypeRequest{}
	this.Id = id
...
func (o *PatchedBulkDeviceTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *PatchedBulkDeviceTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkDeviceTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
	o.DefaultPlatform.Set(&v)
}

// SetDefaultPlatformNil sets the value for DefaultPlatform to be an explicit nil
func (o *PatchedBulkDeviceTypeRequest) SetDefaultPlatformNil() {
...
func (o *PatchedBulkDeviceTypeRequest) GetSubdeviceRole() BulkDeviceTypeRequestSubdeviceRole {
	if o == nil || IsNil(o.SubdeviceRole.Get()) {
		var ret BulkDeviceTypeRequestSubdeviceRole
		return ret
	}
...
// SetSubdeviceRole gets a reference to the given NullableBulkDeviceTypeRequestSubdeviceRole and assigns it to the SubdeviceRole field.
...
func (o *PatchedBulkDeviceTypeRequest) SetSubdeviceRoleNil() {
...
func (o *PatchedBulkDeviceTypeRequest) SetAirflowNil() {
	o.Airflow.Set(nil)
}
...
func (o *PatchedBulkDeviceTypeRequest) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o *PatchedBulkDeviceTypeRequest) SetWeightUnitNil() {
...
func (o *PatchedBulkDeviceTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkDeviceTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkDeviceTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkDeviceTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkDeviceTypeRequest := _PatchedBulkDeviceTypeRequest{}

	err = json.Unmarshal(data, &varPatchedBulkDeviceTypeRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkDeviceTypeRequest(varPatchedBulkDeviceTypeRequest)
...
type NullablePatchedBulkDeviceTypeRequest struct {
	value *PatchedBulkDeviceTypeRequest
	isSet bool
}

func (v NullablePatchedBulkDeviceTypeRequest) Get() *PatchedBulkDeviceTypeRequest {
	return v.value
}

func (v *NullablePatchedBulkDeviceTypeRequest) Set(val *PatchedBulkDeviceTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkDeviceTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkDeviceTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkDeviceTypeRequest(val *PatchedBulkDeviceTypeRequest) *NullablePatchedBulkDeviceTypeRequest {
	return &NullablePatchedBulkDeviceTypeRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkDeviceTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkDeviceTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
