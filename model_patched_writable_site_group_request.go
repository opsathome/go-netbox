...
// PatchedWritableSiteGroupRequest Base serializer class for models inheriting from NestedGroupModel.
...
func (o *PatchedWritableSiteGroupRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableSiteGroupRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableSiteGroupRequest) HasOwner() bool {
...
func (o *PatchedWritableSiteGroupRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedWritableSiteGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *PatchedWritableSiteGroupRequest) UnsetOwner() {
	o.Owner.Unset()
}
