...
// PatchedWritableLocationRequest Base serializer class for models inheriting from NestedGroupModel.
...
func (o *PatchedWritableLocationRequest) GetSite() BulkDeviceWithConfigContextRequestSite {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableLocationRequest) GetSiteOk() (*BulkDeviceWithConfigContextRequestSite, bool) {
	if o == nil || IsNil(o.Site) {
		return nil, false
	}
	return o.Site, true
...
func (o *PatchedWritableLocationRequest) SetSite(v BulkDeviceWithConfigContextRequestSite) {
	o.Site = &v
}
...
func (o *PatchedWritableLocationRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
