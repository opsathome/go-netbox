...
// checks if the PatchedBulkCableBundleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkCableBundleRequest{}

// PatchedBulkCableBundleRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkCableBundleRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkCableBundleRequest PatchedBulkCableBundleRequest
...
func NewPatchedBulkCableBundleRequest(id int32) *PatchedBulkCableBundleRequest {
	this := PatchedBulkCableBundleRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkCableBundleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkCableBundleRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkCableBundleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkCableBundleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkCableBundleRequest := _PatchedBulkCableBundleRequest{}

	err = json.Unmarshal(data, &varPatchedBulkCableBundleRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkCableBundleRequest(varPatchedBulkCableBundleRequest)
...
type NullablePatchedBulkCableBundleRequest struct {
	value *PatchedBulkCableBundleRequest
	isSet bool
}

func (v NullablePatchedBulkCableBundleRequest) Get() *PatchedBulkCableBundleRequest {
	return v.value
}

func (v *NullablePatchedBulkCableBundleRequest) Set(val *PatchedBulkCableBundleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkCableBundleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkCableBundleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkCableBundleRequest(val *PatchedBulkCableBundleRequest) *NullablePatchedBulkCableBundleRequest {
	return &NullablePatchedBulkCableBundleRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkCableBundleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkCableBundleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
