...
// checks if the BulkManufacturerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkManufacturerRequest{}

// BulkManufacturerRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkManufacturerRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkManufacturerRequest BulkManufacturerRequest
...
func (o *BulkManufacturerRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkManufacturerRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkManufacturerRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkManufacturerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkManufacturerRequest := _BulkManufacturerRequest{}

	err = json.Unmarshal(data, &varBulkManufacturerRequest)

	if err != nil {
		return err
	}

	*o = BulkManufacturerRequest(varBulkManufacturerRequest)
...
type NullableBulkManufacturerRequest struct {
	value *BulkManufacturerRequest
	isSet bool
}

func (v NullableBulkManufacturerRequest) Get() *BulkManufacturerRequest {
	return v.value
}

func (v *NullableBulkManufacturerRequest) Set(val *BulkManufacturerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkManufacturerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkManufacturerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkManufacturerRequest(val *BulkManufacturerRequest) *NullableBulkManufacturerRequest {
	return &NullableBulkManufacturerRequest{value: val, isSet: true}
}

func (v NullableBulkManufacturerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkManufacturerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
