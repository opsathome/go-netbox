...
type InterfacePoeType struct {
	Value                *BulkInterfaceRequestPoeType `json:"value,omitempty"`
...
func (o *InterfacePoeType) GetValue() BulkInterfaceRequestPoeType {
...
func (o *InterfacePoeType) GetValueOk() (*BulkInterfaceRequestPoeType, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestPoeType and assigns it to the Value field.
func (o *InterfacePoeType) SetValue(v BulkInterfaceRequestPoeType) {
	o.Value = &v
}
