...
type InterfaceTemplateRfRole struct {
	Value                *BulkInterfaceRequestRfRole `json:"value,omitempty"`
...
func (o *InterfaceTemplateRfRole) GetValue() BulkInterfaceRequestRfRole {
...
func (o *InterfaceTemplateRfRole) GetValueOk() (*BulkInterfaceRequestRfRole, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestRfRole and assigns it to the Value field.
func (o *InterfaceTemplateRfRole) SetValue(v BulkInterfaceRequestRfRole) {
	o.Value = &v
}
