...
// PatchedWritablePowerPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritablePowerPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
