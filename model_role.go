...
// Role Base serializer class for models inheriting from OrganizationalModel.
type Role struct {
	Id                   int32                  `json:"id"`
	Url                  string                 `json:"url"`
...
// SetAsnCount gets a reference to the given int64 and assigns it to the AsnCount field.
