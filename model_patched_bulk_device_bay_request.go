...
// checks if the PatchedBulkDeviceBayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkDeviceBayRequest{}

// PatchedBulkDeviceBayRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkDeviceBayRequest struct {
	Id     int32                        `json:"id"`
...
type _PatchedBulkDeviceBayRequest PatchedBulkDeviceBayRequest
...
func NewPatchedBulkDeviceBayRequest(id int32) *PatchedBulkDeviceBayRequest {
	this := PatchedBulkDeviceBayRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkDeviceBayRequest) GetDevice() BriefInterfaceRequestDevice {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkDeviceBayRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil || IsNil(o.Device) {
		return nil, false
	}
...
func (o *PatchedBulkDeviceBayRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = &v
}
...
func (o *PatchedBulkDeviceBayRequest) SetInstalledDeviceNil() {
...
func (o *PatchedBulkDeviceBayRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkDeviceBayRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkDeviceBayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkDeviceBayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkDeviceBayRequest := _PatchedBulkDeviceBayRequest{}

	err = json.Unmarshal(data, &varPatchedBulkDeviceBayRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkDeviceBayRequest(varPatchedBulkDeviceBayRequest)
...
type NullablePatchedBulkDeviceBayRequest struct {
	value *PatchedBulkDeviceBayRequest
	isSet bool
}

func (v NullablePatchedBulkDeviceBayRequest) Get() *PatchedBulkDeviceBayRequest {
	return v.value
}

func (v *NullablePatchedBulkDeviceBayRequest) Set(val *PatchedBulkDeviceBayRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkDeviceBayRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkDeviceBayRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkDeviceBayRequest(val *PatchedBulkDeviceBayRequest) *NullablePatchedBulkDeviceBayRequest {
	return &NullablePatchedBulkDeviceBayRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkDeviceBayRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkDeviceBayRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
