...
type CustomFieldFilterLogic struct {
	Value                *BulkCustomFieldRequestFilterLogic `json:"value,omitempty"`
...
func (o *CustomFieldFilterLogic) GetValue() BulkCustomFieldRequestFilterLogic {
...
func (o *CustomFieldFilterLogic) GetValueOk() (*BulkCustomFieldRequestFilterLogic, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkCustomFieldRequestFilterLogic and assigns it to the Value field.
func (o *CustomFieldFilterLogic) SetValue(v BulkCustomFieldRequestFilterLogic) {
	o.Value = &v
}
