...
// WritableRearPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func NewWritableRearPortRequest(device BriefInterfaceRequestDevice, name string, type_ BulkFrontPortRequestType) *WritableRearPortRequest {
...
func (o *WritableRearPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *WritableRearPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *WritableRearPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *WritableRearPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
