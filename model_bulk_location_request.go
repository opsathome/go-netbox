...
// checks if the BulkLocationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkLocationRequest{}

// BulkLocationRequest Base serializer class for models inheriting from NestedGroupModel.
...
type _BulkLocationRequest BulkLocationRequest

// NewBulkLocationRequest instantiates a new BulkLocationRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBulkLocationRequest(id int32, name string, slug string, site BulkDeviceWithConfigContextRequestSite) *BulkLocationRequest {
	this := BulkLocationRequest{}
	this.Id = id
	this.Name = name
	this.Slug = slug
	this.Site = site
...
func (o *BulkLocationRequest) GetSite() BulkDeviceWithConfigContextRequestSite {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkLocationRequest) GetSiteOk() (*BulkDeviceWithConfigContextRequestSite, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Site, true
...
func (o *BulkLocationRequest) SetSite(v BulkDeviceWithConfigContextRequestSite) {
	o.Site = v
}
...
func (o *BulkLocationRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkLocationRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkLocationRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkLocationRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkLocationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkLocationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkLocationRequest := _BulkLocationRequest{}

	err = json.Unmarshal(data, &varBulkLocationRequest)

	if err != nil {
		return err
	}

	*o = BulkLocationRequest(varBulkLocationRequest)
...
type NullableBulkLocationRequest struct {
	value *BulkLocationRequest
	isSet bool
}

func (v NullableBulkLocationRequest) Get() *BulkLocationRequest {
	return v.value
}

func (v *NullableBulkLocationRequest) Set(val *BulkLocationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkLocationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkLocationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkLocationRequest(val *BulkLocationRequest) *NullableBulkLocationRequest {
	return &NullableBulkLocationRequest{value: val, isSet: true}
}

func (v NullableBulkLocationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkLocationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
