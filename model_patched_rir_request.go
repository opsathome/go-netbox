...
// PatchedRIRRequest Base serializer class for models inheriting from OrganizationalModel.
...
func (o *PatchedRIRRequest) GetOwner() ASNRangeRequestOwner {
...
func (o *PatchedRIRRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedRIRRequest) HasOwner() bool {
...
func (o *PatchedRIRRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedRIRRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *PatchedRIRRequest) UnsetOwner() {
	o.Owner.Unset()
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *PatchedRIRRequest) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *PatchedRIRRequest) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *PatchedRIRRequest) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
...
func (o *PatchedRIRRequest) SetComments(v string) {
	o.Comments = &v
}
