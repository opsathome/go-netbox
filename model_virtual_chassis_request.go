...
// VirtualChassisRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *VirtualChassisRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VirtualChassisRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualChassisRequest) HasOwner() bool {
...
func (o *VirtualChassisRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *VirtualChassisRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *VirtualChassisRequest) UnsetOwner() {
	o.Owner.Unset()
}
