...
func (o *PatchedWritableConsolePortTemplateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType {
...
func (o *PatchedWritableConsolePortTemplateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableConsolePortTemplateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType) {
	o.DeviceType.Set(&v)
}
...
func (o *PatchedWritableConsolePortTemplateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableConsolePortTemplateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableConsolePortTemplateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType) {
	o.ModuleType.Set(&v)
}
