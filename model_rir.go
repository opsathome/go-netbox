...
// RIR Base serializer class for models inheriting from OrganizationalModel.
type RIR struct {
	Id         int32   `json:"id"`
	Url        string  `json:"url"`
...
func (o *RIR) GetOwner() BriefOwner {
...
func (o *RIR) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RIR) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *RIR) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *RIR) UnsetOwner() {
	o.Owner.Unset()
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *RIR) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *RIR) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *RIR) SetComments(v string) {
	o.Comments = &v
}
