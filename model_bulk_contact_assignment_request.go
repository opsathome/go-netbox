...
// checks if the BulkContactAssignmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkContactAssignmentRequest{}

// BulkContactAssignmentRequest Adds support for custom fields and tags.
type BulkContactAssignmentRequest struct {
	Id                   int32                                               `json:"id"`
	ObjectType           string                                              `json:"object_type"`
	ObjectId             int64                                               `json:"object_id"`
	Contact              BulkContactAssignmentRequestContact                 `json:"contact"`
...
type _BulkContactAssignmentRequest BulkContactAssignmentRequest
...
func NewBulkContactAssignmentRequest(id int32, objectType string, objectId int64, contact BulkContactAssignmentRequestContact) *BulkContactAssignmentRequest {
	this := BulkContactAssignmentRequest{}
	this.Id = id
...
func (o *BulkContactAssignmentRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o BulkContactAssignmentRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkContactAssignmentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkContactAssignmentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkContactAssignmentRequest := _BulkContactAssignmentRequest{}

	err = json.Unmarshal(data, &varBulkContactAssignmentRequest)

	if err != nil {
		return err
	}

	*o = BulkContactAssignmentRequest(varBulkContactAssignmentRequest)
...
type NullableBulkContactAssignmentRequest struct {
	value *BulkContactAssignmentRequest
	isSet bool
}

func (v NullableBulkContactAssignmentRequest) Get() *BulkContactAssignmentRequest {
	return v.value
}

func (v *NullableBulkContactAssignmentRequest) Set(val *BulkContactAssignmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkContactAssignmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkContactAssignmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkContactAssignmentRequest(val *BulkContactAssignmentRequest) *NullableBulkContactAssignmentRequest {
	return &NullableBulkContactAssignmentRequest{value: val, isSet: true}
}

func (v NullableBulkContactAssignmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkContactAssignmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
