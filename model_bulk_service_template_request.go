...
// checks if the BulkServiceTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkServiceTemplateRequest{}

// BulkServiceTemplateRequest Base serializer class for models inheriting from PrimaryModel.
type BulkServiceTemplateRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkServiceTemplateRequest BulkServiceTemplateRequest
...
func NewBulkServiceTemplateRequest(id int32, name string, ports []int32) *BulkServiceTemplateRequest {
	this := BulkServiceTemplateRequest{}
	this.Id = id
	this.Name = name
	this.Ports = ports
	return &this
...
func (o *BulkServiceTemplateRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkServiceTemplateRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkServiceTemplateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkServiceTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkServiceTemplateRequest := _BulkServiceTemplateRequest{}

	err = json.Unmarshal(data, &varBulkServiceTemplateRequest)

	if err != nil {
		return err
	}

	*o = BulkServiceTemplateRequest(varBulkServiceTemplateRequest)
...
type NullableBulkServiceTemplateRequest struct {
	value *BulkServiceTemplateRequest
	isSet bool
}

func (v NullableBulkServiceTemplateRequest) Get() *BulkServiceTemplateRequest {
	return v.value
}

func (v *NullableBulkServiceTemplateRequest) Set(val *BulkServiceTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkServiceTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkServiceTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkServiceTemplateRequest(val *BulkServiceTemplateRequest) *NullableBulkServiceTemplateRequest {
	return &NullableBulkServiceTemplateRequest{value: val, isSet: true}
}

func (v NullableBulkServiceTemplateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkServiceTemplateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
