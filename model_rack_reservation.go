...
func NewRackReservation(id int32, url string, display string, rack BriefRack, units []int32, unitCount int32, user BriefUser, description string) *RackReservation {
...
// SetStatus gets a reference to the given RackReservationStatus and assigns it to the Status field.
...
func (o *RackReservation) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o RackReservation) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["unit_count"] = o.UnitCount
	if !IsNil(o.Status) {
...
func (o *RackReservation) UnmarshalJSON(data []byte) (err error) {
	...
	*o = RackReservation(varRackReservation)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "unit_count")
