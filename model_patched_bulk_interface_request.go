...
// checks if the PatchedBulkInterfaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkInterfaceRequest{}

// PatchedBulkInterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type PatchedBulkInterfaceRequest struct {
	Id     int32                                `json:"id"`
...
type _PatchedBulkInterfaceRequest PatchedBulkInterfaceRequest
...
func NewPatchedBulkInterfaceRequest(id int32) *PatchedBulkInterfaceRequest {
	this := PatchedBulkInterfaceRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkInterfaceRequest) GetDevice() BriefInterfaceRequestDevice {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkInterfaceRequest) GetDeviceOk() (*BriefInterfaceRequestDevice, bool) {
	if o == nil || IsNil(o.Device) {
		return nil, false
	}
...
func (o *PatchedBulkInterfaceRequest) SetDevice(v BriefInterfaceRequestDevice) {
	o.Device = &v
}
...
func (o *PatchedBulkInterfaceRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetBridgeNil() {
	o.Bridge.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetLagNil() {
	o.Lag.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetPrimaryMacAddressNil() {
...
func (o *PatchedBulkInterfaceRequest) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetDuplexNil() {
	o.Duplex.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetWwnNil() {
	o.Wwn.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetRfChannelFrequencyNil() {
...
func (o *PatchedBulkInterfaceRequest) SetRfChannelWidthNil() {
...
func (o *PatchedBulkInterfaceRequest) SetTxPowerNil() {
	o.TxPower.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetUntaggedVlanNil() {
...
func (o *PatchedBulkInterfaceRequest) SetQinqSvlanNil() {
	o.QinqSvlan.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetVlanTranslationPolicyNil() {
...
func (o *PatchedBulkInterfaceRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *PatchedBulkInterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkInterfaceRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkInterfaceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkInterfaceRequest := _PatchedBulkInterfaceRequest{}

	err = json.Unmarshal(data, &varPatchedBulkInterfaceRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkInterfaceRequest(varPatchedBulkInterfaceRequest)
...
type NullablePatchedBulkInterfaceRequest struct {
	value *PatchedBulkInterfaceRequest
	isSet bool
}

func (v NullablePatchedBulkInterfaceRequest) Get() *PatchedBulkInterfaceRequest {
	return v.value
}

func (v *NullablePatchedBulkInterfaceRequest) Set(val *PatchedBulkInterfaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkInterfaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkInterfaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkInterfaceRequest(val *PatchedBulkInterfaceRequest) *NullablePatchedBulkInterfaceRequest {
	return &NullablePatchedBulkInterfaceRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkInterfaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkInterfaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
