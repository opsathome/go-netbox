...
func (o *PowerOutletTemplateRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PowerOutletTemplateRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PowerOutletTemplateRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
