...
// PatchedWritableRearPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritableRearPortRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableRearPortRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedWritableRearPortRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PatchedWritableRearPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
