...
type TunnelStatus struct {
	Value                *BulkTunnelRequestStatus `json:"value,omitempty"`
...
func (o *TunnelStatus) GetValue() BulkTunnelRequestStatus {
...
func (o *TunnelStatus) GetValueOk() (*BulkTunnelRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkTunnelRequestStatus and assigns it to the Value field.
func (o *TunnelStatus) SetValue(v BulkTunnelRequestStatus) {
	o.Value = &v
}
