...
func (o *PatchedWritableFrontPortTemplateRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritableFrontPortTemplateRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedWritableFrontPortTemplateRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
