...
// WritableRackReservationRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewWritableRackReservationRequest(rack BulkRackReservationRequestRack, units []int32, user BookmarkRequestUser, description string) *WritableRackReservationRequest {
...
func (o *WritableRackReservationRequest) GetRack() BulkRackReservationRequestRack {
	if o == nil {
...
func (o *WritableRackReservationRequest) GetRackOk() (*BulkRackReservationRequestRack, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Rack, true
...
func (o *WritableRackReservationRequest) SetRack(v BulkRackReservationRequestRack) {
	o.Rack = v
}
...
func (o *WritableRackReservationRequest) GetStatus() BulkRackReservationRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *WritableRackReservationRequest) GetStatusOk() (*BulkRackReservationRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritableRackReservationRequest) SetStatus(v BulkRackReservationRequestStatus) {
	o.Status = &v
}
...
func (o *WritableRackReservationRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
