...
// checks if the BulkTunnelGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkTunnelGroupRequest{}

// BulkTunnelGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkTunnelGroupRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkTunnelGroupRequest BulkTunnelGroupRequest
...
func (o *BulkTunnelGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkTunnelGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkTunnelGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkTunnelGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkTunnelGroupRequest := _BulkTunnelGroupRequest{}

	err = json.Unmarshal(data, &varBulkTunnelGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkTunnelGroupRequest(varBulkTunnelGroupRequest)
...
type NullableBulkTunnelGroupRequest struct {
	value *BulkTunnelGroupRequest
	isSet bool
}

func (v NullableBulkTunnelGroupRequest) Get() *BulkTunnelGroupRequest {
	return v.value
}

func (v *NullableBulkTunnelGroupRequest) Set(val *BulkTunnelGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkTunnelGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkTunnelGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkTunnelGroupRequest(val *BulkTunnelGroupRequest) *NullableBulkTunnelGroupRequest {
	return &NullableBulkTunnelGroupRequest{value: val, isSet: true}
}

func (v NullableBulkTunnelGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkTunnelGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
