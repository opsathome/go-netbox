...
type IKEProposalEncryptionAlgorithm struct {
	Value                *BulkIKEProposalRequestEncryptionAlgorithm `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkIKEProposalRequestEncryptionAlgorithm and assigns it to the Value field.
