...
// PatchedWritableConsoleServerPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritableConsoleServerPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
