...
type PowerFeedStatus struct {
	Value                *BulkPowerFeedRequestStatus `json:"value,omitempty"`
...
func (o *PowerFeedStatus) GetValue() BulkPowerFeedRequestStatus {
...
func (o *PowerFeedStatus) GetValueOk() (*BulkPowerFeedRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkPowerFeedRequestStatus and assigns it to the Value field.
func (o *PowerFeedStatus) SetValue(v BulkPowerFeedRequestStatus) {
	o.Value = &v
}
