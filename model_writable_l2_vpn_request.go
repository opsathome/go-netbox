...
// WritableL2VPNRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *WritableL2VPNRequest) GetStatus() BulkL2VPNRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *WritableL2VPNRequest) GetStatusOk() (*BulkL2VPNRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *WritableL2VPNRequest) SetStatus(v BulkL2VPNRequestStatus) {
	o.Status = &v
}
...
func (o *WritableL2VPNRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableL2VPNRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableL2VPNRequest) HasOwner() bool {
...
func (o *WritableL2VPNRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *WritableL2VPNRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *WritableL2VPNRequest) UnsetOwner() {
	o.Owner.Unset()
}
