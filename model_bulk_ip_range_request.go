...
// checks if the BulkIPRangeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkIPRangeRequest{}

// BulkIPRangeRequest Base serializer class for models inheriting from PrimaryModel.
type BulkIPRangeRequest struct {
	Id           int32                           `json:"id"`
...
type _BulkIPRangeRequest BulkIPRangeRequest
...
func (o *BulkIPRangeRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *BulkIPRangeRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkIPRangeRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *BulkIPRangeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkIPRangeRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkIPRangeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkIPRangeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkIPRangeRequest := _BulkIPRangeRequest{}

	err = json.Unmarshal(data, &varBulkIPRangeRequest)

	if err != nil {
		return err
	}

	*o = BulkIPRangeRequest(varBulkIPRangeRequest)
...
type NullableBulkIPRangeRequest struct {
	value *BulkIPRangeRequest
	isSet bool
}

func (v NullableBulkIPRangeRequest) Get() *BulkIPRangeRequest {
	return v.value
}

func (v *NullableBulkIPRangeRequest) Set(val *BulkIPRangeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkIPRangeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkIPRangeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkIPRangeRequest(val *BulkIPRangeRequest) *NullableBulkIPRangeRequest {
	return &NullableBulkIPRangeRequest{value: val, isSet: true}
}

func (v NullableBulkIPRangeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkIPRangeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
