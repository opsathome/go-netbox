...
// InterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func NewInterfaceRequest(device BriefInterfaceRequestDevice, name string, type_ BulkInterfaceRequestType) *InterfaceRequest {
...
func (o *InterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
