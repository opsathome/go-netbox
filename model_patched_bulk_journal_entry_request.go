...
// checks if the PatchedBulkJournalEntryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkJournalEntryRequest{}

// PatchedBulkJournalEntryRequest Adds support for custom fields and tags.
type PatchedBulkJournalEntryRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkJournalEntryRequest PatchedBulkJournalEntryRequest
...
func NewPatchedBulkJournalEntryRequest(id int32) *PatchedBulkJournalEntryRequest {
	this := PatchedBulkJournalEntryRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkJournalEntryRequest) SetCreatedByNil() {
	o.CreatedBy.Set(nil)
}
...
func (o PatchedBulkJournalEntryRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkJournalEntryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkJournalEntryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkJournalEntryRequest := _PatchedBulkJournalEntryRequest{}

	err = json.Unmarshal(data, &varPatchedBulkJournalEntryRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkJournalEntryRequest(varPatchedBulkJournalEntryRequest)
...
type NullablePatchedBulkJournalEntryRequest struct {
	value *PatchedBulkJournalEntryRequest
	isSet bool
}

func (v NullablePatchedBulkJournalEntryRequest) Get() *PatchedBulkJournalEntryRequest {
	return v.value
}

func (v *NullablePatchedBulkJournalEntryRequest) Set(val *PatchedBulkJournalEntryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkJournalEntryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkJournalEntryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkJournalEntryRequest(val *PatchedBulkJournalEntryRequest) *NullablePatchedBulkJournalEntryRequest {
	return &NullablePatchedBulkJournalEntryRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkJournalEntryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkJournalEntryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
