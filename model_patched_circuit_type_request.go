...
// PatchedCircuitTypeRequest Base serializer class for models inheriting from OrganizationalModel.
...
func (o *PatchedCircuitTypeRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *PatchedCircuitTypeRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *PatchedCircuitTypeRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *PatchedCircuitTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
