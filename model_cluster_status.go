...
type ClusterStatus struct {
	Value                *BulkClusterRequestStatus `json:"value,omitempty"`
...
func (o *ClusterStatus) GetValue() BulkClusterRequestStatus {
...
func (o *ClusterStatus) GetValueOk() (*BulkClusterRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkClusterRequestStatus and assigns it to the Value field.
func (o *ClusterStatus) SetValue(v BulkClusterRequestStatus) {
	o.Value = &v
}
