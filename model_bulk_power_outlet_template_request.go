...
// checks if the BulkPowerOutletTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkPowerOutletTemplateRequest{}

// BulkPowerOutletTemplateRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
type BulkPowerOutletTemplateRequest struct {
	Id         int32                                            `json:"id"`
...
type _BulkPowerOutletTemplateRequest BulkPowerOutletTemplateRequest
...
func NewBulkPowerOutletTemplateRequest(id int32, name string) *BulkPowerOutletTemplateRequest {
	this := BulkPowerOutletTemplateRequest{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BulkPowerOutletTemplateRequest) SetDeviceTypeNil() {
...
func (o *BulkPowerOutletTemplateRequest) SetModuleTypeNil() {
...
func (o *BulkPowerOutletTemplateRequest) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *BulkPowerOutletTemplateRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *BulkPowerOutletTemplateRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *BulkPowerOutletTemplateRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *BulkPowerOutletTemplateRequest) SetPowerPortNil() {
	o.PowerPort.Set(nil)
}
...
func (o *BulkPowerOutletTemplateRequest) SetFeedLegNil() {
	o.FeedLeg.Set(nil)
}
...
func (o BulkPowerOutletTemplateRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkPowerOutletTemplateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkPowerOutletTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkPowerOutletTemplateRequest := _BulkPowerOutletTemplateRequest{}

	err = json.Unmarshal(data, &varBulkPowerOutletTemplateRequest)

	if err != nil {
		return err
	}

	*o = BulkPowerOutletTemplateRequest(varBulkPowerOutletTemplateRequest)
...
type NullableBulkPowerOutletTemplateRequest struct {
	value *BulkPowerOutletTemplateRequest
	isSet bool
}

func (v NullableBulkPowerOutletTemplateRequest) Get() *BulkPowerOutletTemplateRequest {
	return v.value
}

func (v *NullableBulkPowerOutletTemplateRequest) Set(val *BulkPowerOutletTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkPowerOutletTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkPowerOutletTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkPowerOutletTemplateRequest(val *BulkPowerOutletTemplateRequest) *NullableBulkPowerOutletTemplateRequest {
	return &NullableBulkPowerOutletTemplateRequest{value: val, isSet: true}
}

func (v NullableBulkPowerOutletTemplateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkPowerOutletTemplateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
