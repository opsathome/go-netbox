...
// checks if the BulkClusterGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkClusterGroupRequest{}

// BulkClusterGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkClusterGroupRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkClusterGroupRequest BulkClusterGroupRequest
...
func (o *BulkClusterGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkClusterGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkClusterGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkClusterGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkClusterGroupRequest := _BulkClusterGroupRequest{}

	err = json.Unmarshal(data, &varBulkClusterGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkClusterGroupRequest(varBulkClusterGroupRequest)
...
type NullableBulkClusterGroupRequest struct {
	value *BulkClusterGroupRequest
	isSet bool
}

func (v NullableBulkClusterGroupRequest) Get() *BulkClusterGroupRequest {
	return v.value
}

func (v *NullableBulkClusterGroupRequest) Set(val *BulkClusterGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkClusterGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkClusterGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkClusterGroupRequest(val *BulkClusterGroupRequest) *NullableBulkClusterGroupRequest {
	return &NullableBulkClusterGroupRequest{value: val, isSet: true}
}

func (v NullableBulkClusterGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkClusterGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
