...
// PatchedWritablePowerFeedRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PatchedWritablePowerFeedRequest) GetRack() BulkDeviceWithConfigContextRequestRack {
...
func (o *PatchedWritablePowerFeedRequest) GetRackOk() (*BulkDeviceWithConfigContextRequestRack, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritablePowerFeedRequest) SetRack(v BulkDeviceWithConfigContextRequestRack) {
	o.Rack.Set(&v)
}
...
func (o *PatchedWritablePowerFeedRequest) GetStatus() BulkPowerFeedRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *PatchedWritablePowerFeedRequest) GetStatusOk() (*BulkPowerFeedRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PatchedWritablePowerFeedRequest) SetStatus(v BulkPowerFeedRequestStatus) {
	o.Status = &v
}
...
func (o *PatchedWritablePowerFeedRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
