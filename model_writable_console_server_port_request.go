...
// WritableConsoleServerPortRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *WritableConsoleServerPortRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
