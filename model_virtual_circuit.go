...
// VirtualCircuit Base serializer class for models inheriting from PrimaryModel.
...
func (o *VirtualCircuit) GetOwner() BriefOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *VirtualCircuit) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualCircuit) HasOwner() bool {
...
func (o *VirtualCircuit) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *VirtualCircuit) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *VirtualCircuit) UnsetOwner() {
	o.Owner.Unset()
}
