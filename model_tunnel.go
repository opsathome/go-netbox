...
// Tunnel Base serializer class for models inheriting from PrimaryModel.
type Tunnel struct {
	Id                   int32                     `json:"id"`
	Url                  string                    `json:"url"`
...
func (o *Tunnel) GetOwner() BriefOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Tunnel) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Tunnel) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *Tunnel) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *Tunnel) UnsetOwner() {
	o.Owner.Unset()
}
