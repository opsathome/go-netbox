...
type CustomFieldChoiceSet struct {
	...
	BaseChoices  NullableCustomFieldChoiceSetBaseChoices                      `json:"base_choices,omitempty"`
	...
	ChoicesCount         *int32             `json:"choices_count,omitempty"`
...
// SetBaseChoices gets a reference to the given NullableCustomFieldChoiceSetBaseChoices and assigns it to the BaseChoices field.
...
func (o *CustomFieldChoiceSet) SetBaseChoicesNil() {
...
// SetChoicesCount gets a reference to the given int32 and assigns it to the ChoicesCount field.
...
func (o *CustomFieldChoiceSet) SetOwnerNil() {
	o.Owner.Set(nil)
}
