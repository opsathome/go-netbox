...
func (o *PatchedWritableTunnelTerminationRequest) GetOutsideIp() BulkDeviceWithConfigContextRequestPrimaryIp4 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedWritableTunnelTerminationRequest) GetOutsideIpOk() (*BulkDeviceWithConfigContextRequestPrimaryIp4, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableTunnelTerminationRequest) SetOutsideIp(v BulkDeviceWithConfigContextRequestPrimaryIp4) {
	o.OutsideIp.Set(&v)
}
