...
// checks if the BulkVMInterfaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkVMInterfaceRequest{}

// BulkVMInterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkVMInterfaceRequest struct {
	Id                    int32                                             `json:"id"`
...
type _BulkVMInterfaceRequest BulkVMInterfaceRequest
...
func (o *BulkVMInterfaceRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkVMInterfaceRequest) SetBridgeNil() {
	o.Bridge.Set(nil)
}
...
func (o *BulkVMInterfaceRequest) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *BulkVMInterfaceRequest) SetPrimaryMacAddressNil() {
...
func (o *BulkVMInterfaceRequest) SetUntaggedVlanNil() {
...
func (o *BulkVMInterfaceRequest) SetQinqSvlanNil() {
	o.QinqSvlan.Set(nil)
}
...
func (o *BulkVMInterfaceRequest) SetVlanTranslationPolicyNil() {
...
func (o *BulkVMInterfaceRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *BulkVMInterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkVMInterfaceRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkVMInterfaceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkVMInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkVMInterfaceRequest := _BulkVMInterfaceRequest{}

	err = json.Unmarshal(data, &varBulkVMInterfaceRequest)

	if err != nil {
		return err
	}

	*o = BulkVMInterfaceRequest(varBulkVMInterfaceRequest)
...
type NullableBulkVMInterfaceRequest struct {
	value *BulkVMInterfaceRequest
	isSet bool
}

func (v NullableBulkVMInterfaceRequest) Get() *BulkVMInterfaceRequest {
	return v.value
}

func (v *NullableBulkVMInterfaceRequest) Set(val *BulkVMInterfaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkVMInterfaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkVMInterfaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkVMInterfaceRequest(val *BulkVMInterfaceRequest) *NullableBulkVMInterfaceRequest {
	return &NullableBulkVMInterfaceRequest{value: val, isSet: true}
}

func (v NullableBulkVMInterfaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkVMInterfaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
