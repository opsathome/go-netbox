...
type PowerFeedSupply struct {
	Value                *BulkPowerFeedRequestSupply `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkPowerFeedRequestSupply and assigns it to the Value field.
