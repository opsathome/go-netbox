...
// checks if the PatchedBulkCircuitRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkCircuitRequest{}

// PatchedBulkCircuitRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkCircuitRequest struct {
	Id int32 `json:"id"`
	// Unique circuit ID
	...
	Type            *BulkCircuitRequestType                   `json:"type,omitempty"`
...
type _PatchedBulkCircuitRequest PatchedBulkCircuitRequest
...
func NewPatchedBulkCircuitRequest(id int32) *PatchedBulkCircuitRequest {
	this := PatchedBulkCircuitRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkCircuitRequest) SetProviderAccountNil() {
...
// SetType gets a reference to the given BulkCircuitRequestType and assigns it to the Type field.
...
func (o *PatchedBulkCircuitRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkCircuitRequest) SetInstallDateNil() {
...
func (o *PatchedBulkCircuitRequest) SetTerminationDateNil() {
...
func (o *PatchedBulkCircuitRequest) SetCommitRateNil() {
...
func (o *PatchedBulkCircuitRequest) SetDistanceNil() {
	o.Distance.Set(nil)
}
...
func (o *PatchedBulkCircuitRequest) SetDistanceUnitNil() {
...
func (o *PatchedBulkCircuitRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkCircuitRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkCircuitRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkCircuitRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkCircuitRequest := _PatchedBulkCircuitRequest{}

	err = json.Unmarshal(data, &varPatchedBulkCircuitRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkCircuitRequest(varPatchedBulkCircuitRequest)
...
type NullablePatchedBulkCircuitRequest struct {
	value *PatchedBulkCircuitRequest
	isSet bool
}

func (v NullablePatchedBulkCircuitRequest) Get() *PatchedBulkCircuitRequest {
	return v.value
}

func (v *NullablePatchedBulkCircuitRequest) Set(val *PatchedBulkCircuitRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkCircuitRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkCircuitRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkCircuitRequest(val *PatchedBulkCircuitRequest) *NullablePatchedBulkCircuitRequest {
	return &NullablePatchedBulkCircuitRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkCircuitRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkCircuitRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
