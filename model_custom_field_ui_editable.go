...
type CustomFieldUiEditable struct {
	Value                *BulkCustomFieldRequestUiEditable `json:"value,omitempty"`
...
// SetValue gets a reference to the given BulkCustomFieldRequestUiEditable and assigns it to the Value field.
