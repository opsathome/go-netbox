...
// checks if the PatchedBulkRegionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkRegionRequest{}

// PatchedBulkRegionRequest Base serializer class for models inheriting from NestedGroupModel.
type PatchedBulkRegionRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkRegionRequest PatchedBulkRegionRequest
...
func (o *PatchedBulkRegionRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *PatchedBulkRegionRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkRegionRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkRegionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkRegionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkRegionRequest := _PatchedBulkRegionRequest{}

	err = json.Unmarshal(data, &varPatchedBulkRegionRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkRegionRequest(varPatchedBulkRegionRequest)
...
type NullablePatchedBulkRegionRequest struct {
	value *PatchedBulkRegionRequest
	isSet bool
}

func (v NullablePatchedBulkRegionRequest) Get() *PatchedBulkRegionRequest {
	return v.value
}

func (v *NullablePatchedBulkRegionRequest) Set(val *PatchedBulkRegionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkRegionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkRegionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkRegionRequest(val *PatchedBulkRegionRequest) *NullablePatchedBulkRegionRequest {
	return &NullablePatchedBulkRegionRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkRegionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkRegionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
