...
// checks if the PatchedBulkRackRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkRackRoleRequest{}

// PatchedBulkRackRoleRequest Base serializer class for models inheriting from OrganizationalModel.
type PatchedBulkRackRoleRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkRackRoleRequest PatchedBulkRackRoleRequest
...
func NewPatchedBulkRackRoleRequest(id int32) *PatchedBulkRackRoleRequest {
	this := PatchedBulkRackRoleRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkRackRoleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkRackRoleRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkRackRoleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkRackRoleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkRackRoleRequest := _PatchedBulkRackRoleRequest{}

	err = json.Unmarshal(data, &varPatchedBulkRackRoleRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkRackRoleRequest(varPatchedBulkRackRoleRequest)
...
type NullablePatchedBulkRackRoleRequest struct {
	value *PatchedBulkRackRoleRequest
	isSet bool
}

func (v NullablePatchedBulkRackRoleRequest) Get() *PatchedBulkRackRoleRequest {
	return v.value
}

func (v *NullablePatchedBulkRackRoleRequest) Set(val *PatchedBulkRackRoleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkRackRoleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkRackRoleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkRackRoleRequest(val *PatchedBulkRackRoleRequest) *NullablePatchedBulkRackRoleRequest {
	return &NullablePatchedBulkRackRoleRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkRackRoleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkRackRoleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
