...
// checks if the BulkClusterTypeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkClusterTypeRequest{}

// BulkClusterTypeRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkClusterTypeRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkClusterTypeRequest BulkClusterTypeRequest
...
func (o *BulkClusterTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkClusterTypeRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkClusterTypeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkClusterTypeRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkClusterTypeRequest := _BulkClusterTypeRequest{}

	err = json.Unmarshal(data, &varBulkClusterTypeRequest)

	if err != nil {
		return err
	}

	*o = BulkClusterTypeRequest(varBulkClusterTypeRequest)
...
type NullableBulkClusterTypeRequest struct {
	value *BulkClusterTypeRequest
	isSet bool
}

func (v NullableBulkClusterTypeRequest) Get() *BulkClusterTypeRequest {
	return v.value
}

func (v *NullableBulkClusterTypeRequest) Set(val *BulkClusterTypeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkClusterTypeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkClusterTypeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkClusterTypeRequest(val *BulkClusterTypeRequest) *NullableBulkClusterTypeRequest {
	return &NullableBulkClusterTypeRequest{value: val, isSet: true}
}

func (v NullableBulkClusterTypeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkClusterTypeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
