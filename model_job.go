...
func NewJob(id int32, url string, display string, objectType string, name string, status BriefJobStatus, user BriefUser, error_ string, jobId string, notifications JobNotifications) *Job {
	this := Job{}
	this.Id = id
	this.Url = url
