...
func (o *PlatformRequest) GetConfigTemplate() BulkDeviceRoleRequestConfigTemplate {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PlatformRequest) GetConfigTemplateOk() (*BulkDeviceRoleRequestConfigTemplate, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PlatformRequest) SetConfigTemplate(v BulkDeviceRoleRequestConfigTemplate) {
