...
// checks if the BulkCustomLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkCustomLinkRequest{}

// BulkCustomLinkRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
type BulkCustomLinkRequest struct {
	Id          int32    `json:"id"`
...
type _BulkCustomLinkRequest BulkCustomLinkRequest
...
func (o *BulkCustomLinkRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkCustomLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkCustomLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkCustomLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkCustomLinkRequest := _BulkCustomLinkRequest{}

	err = json.Unmarshal(data, &varBulkCustomLinkRequest)

	if err != nil {
		return err
	}

	*o = BulkCustomLinkRequest(varBulkCustomLinkRequest)
...
type NullableBulkCustomLinkRequest struct {
	value *BulkCustomLinkRequest
	isSet bool
}

func (v NullableBulkCustomLinkRequest) Get() *BulkCustomLinkRequest {
	return v.value
}

func (v *NullableBulkCustomLinkRequest) Set(val *BulkCustomLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkCustomLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkCustomLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkCustomLinkRequest(val *BulkCustomLinkRequest) *NullableBulkCustomLinkRequest {
	return &NullableBulkCustomLinkRequest{value: val, isSet: true}
}

func (v NullableBulkCustomLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkCustomLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
