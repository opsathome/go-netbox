...
type InventoryItemStatus struct {
	Value                *BulkInventoryItemRequestStatus `json:"value,omitempty"`
...
func (o *InventoryItemStatus) GetValue() BulkInventoryItemRequestStatus {
...
func (o *InventoryItemStatus) GetValueOk() (*BulkInventoryItemRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInventoryItemRequestStatus and assigns it to the Value field.
func (o *InventoryItemStatus) SetValue(v BulkInventoryItemRequestStatus) {
	o.Value = &v
}
