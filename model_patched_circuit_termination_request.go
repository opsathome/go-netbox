...
func (o *PatchedCircuitTerminationRequest) GetCircuit() BulkCircuitTerminationRequestCircuit {
...
func (o *PatchedCircuitTerminationRequest) GetCircuitOk() (*BulkCircuitTerminationRequestCircuit, bool) {
	if o == nil || IsNil(o.Circuit) {
		return nil, false
	}
...
func (o *PatchedCircuitTerminationRequest) SetCircuit(v BulkCircuitTerminationRequestCircuit) {
	o.Circuit = &v
}
