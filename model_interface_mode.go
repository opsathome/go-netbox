...
type InterfaceMode struct {
	Value                *BulkInterfaceRequestMode `json:"value,omitempty"`
...
func (o *InterfaceMode) GetValue() BulkInterfaceRequestMode {
...
func (o *InterfaceMode) GetValueOk() (*BulkInterfaceRequestMode, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestMode and assigns it to the Value field.
func (o *InterfaceMode) SetValue(v BulkInterfaceRequestMode) {
	o.Value = &v
}
