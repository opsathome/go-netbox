...
// checks if the PatchedBulkRouteTargetRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkRouteTargetRequest{}

// PatchedBulkRouteTargetRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkRouteTargetRequest struct {
	Id int32 `json:"id"`
...
type _PatchedBulkRouteTargetRequest PatchedBulkRouteTargetRequest
...
func NewPatchedBulkRouteTargetRequest(id int32) *PatchedBulkRouteTargetRequest {
	this := PatchedBulkRouteTargetRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkRouteTargetRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkRouteTargetRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkRouteTargetRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkRouteTargetRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkRouteTargetRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkRouteTargetRequest := _PatchedBulkRouteTargetRequest{}

	err = json.Unmarshal(data, &varPatchedBulkRouteTargetRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkRouteTargetRequest(varPatchedBulkRouteTargetRequest)
...
type NullablePatchedBulkRouteTargetRequest struct {
	value *PatchedBulkRouteTargetRequest
	isSet bool
}

func (v NullablePatchedBulkRouteTargetRequest) Get() *PatchedBulkRouteTargetRequest {
	return v.value
}

func (v *NullablePatchedBulkRouteTargetRequest) Set(val *PatchedBulkRouteTargetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkRouteTargetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkRouteTargetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkRouteTargetRequest(val *PatchedBulkRouteTargetRequest) *NullablePatchedBulkRouteTargetRequest {
	return &NullablePatchedBulkRouteTargetRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkRouteTargetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkRouteTargetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
