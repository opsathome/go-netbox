...
func (o *ExportTemplateRequest) GetDataSource() BulkConfigContextProfileRequestDataSource {
...
// and a boolean to check if the value has been set.
func (o *ExportTemplateRequest) GetDataSourceOk() (*BulkConfigContextProfileRequestDataSource, bool) {
	if o == nil || IsNil(o.DataSource) {
		return nil, false
	}
...
func (o *ExportTemplateRequest) SetDataSource(v BulkConfigContextProfileRequestDataSource) {
	o.DataSource = &v
}
