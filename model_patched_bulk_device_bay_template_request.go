...
// checks if the PatchedBulkDeviceBayTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkDeviceBayTemplateRequest{}
...
type PatchedBulkDeviceBayTemplateRequest struct {
	Id         int32                                   `json:"id"`
...
type _PatchedBulkDeviceBayTemplateRequest PatchedBulkDeviceBayTemplateRequest
...
func NewPatchedBulkDeviceBayTemplateRequest(id int32) *PatchedBulkDeviceBayTemplateRequest {
	this := PatchedBulkDeviceBayTemplateRequest{}
	this.Id = id
	return &this
}
...
func (o PatchedBulkDeviceBayTemplateRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkDeviceBayTemplateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkDeviceBayTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkDeviceBayTemplateRequest := _PatchedBulkDeviceBayTemplateRequest{}

	err = json.Unmarshal(data, &varPatchedBulkDeviceBayTemplateRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkDeviceBayTemplateRequest(varPatchedBulkDeviceBayTemplateRequest)
...
type NullablePatchedBulkDeviceBayTemplateRequest struct {
	value *PatchedBulkDeviceBayTemplateRequest
	isSet bool
}

func (v NullablePatchedBulkDeviceBayTemplateRequest) Get() *PatchedBulkDeviceBayTemplateRequest {
	return v.value
}

func (v *NullablePatchedBulkDeviceBayTemplateRequest) Set(val *PatchedBulkDeviceBayTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkDeviceBayTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkDeviceBayTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkDeviceBayTemplateRequest(val *PatchedBulkDeviceBayTemplateRequest) *NullablePatchedBulkDeviceBayTemplateRequest {
	return &NullablePatchedBulkDeviceBayTemplateRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkDeviceBayTemplateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkDeviceBayTemplateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
