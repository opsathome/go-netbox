...
// checks if the BulkContactGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkContactGroupRequest{}

// BulkContactGroupRequest Base serializer class for models inheriting from NestedGroupModel.
type BulkContactGroupRequest struct {
	Id                   int32                             `json:"id"`
...
type _BulkContactGroupRequest BulkContactGroupRequest
...
func (o *BulkContactGroupRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkContactGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkContactGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkContactGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkContactGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkContactGroupRequest := _BulkContactGroupRequest{}

	err = json.Unmarshal(data, &varBulkContactGroupRequest)

	if err != nil {
		return err
	}

	*o = BulkContactGroupRequest(varBulkContactGroupRequest)
...
type NullableBulkContactGroupRequest struct {
	value *BulkContactGroupRequest
	isSet bool
}

func (v NullableBulkContactGroupRequest) Get() *BulkContactGroupRequest {
	return v.value
}

func (v *NullableBulkContactGroupRequest) Set(val *BulkContactGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkContactGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkContactGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkContactGroupRequest(val *BulkContactGroupRequest) *NullableBulkContactGroupRequest {
	return &NullableBulkContactGroupRequest{value: val, isSet: true}
}

func (v NullableBulkContactGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkContactGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
