...
// WritableCustomFieldRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *WritableCustomFieldRequest) GetValidationSchema() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCustomFieldRequest) GetValidationSchemaOk() (*interface{}, bool) {
...
func (o *WritableCustomFieldRequest) HasValidationSchema() bool {
	if o != nil && !IsNil(o.ValidationSchema) {
		return true
	}
...
func (o *WritableCustomFieldRequest) SetValidationSchema(v interface{}) {
...
func (o *WritableCustomFieldRequest) GetChoiceSet() BulkCustomFieldRequestChoiceSet {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCustomFieldRequest) GetChoiceSetOk() (*BulkCustomFieldRequestChoiceSet, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableCustomFieldRequest) SetChoiceSet(v BulkCustomFieldRequestChoiceSet) {
	o.ChoiceSet.Set(&v)
}
...
func (o *WritableCustomFieldRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
