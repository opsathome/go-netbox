...
// PowerFeedRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PowerFeedRequest) GetRack() BulkDeviceWithConfigContextRequestRack {
...
func (o *PowerFeedRequest) GetRackOk() (*BulkDeviceWithConfigContextRequestRack, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PowerFeedRequest) SetRack(v BulkDeviceWithConfigContextRequestRack) {
	o.Rack.Set(&v)
}
...
func (o *PowerFeedRequest) GetStatus() BulkPowerFeedRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *PowerFeedRequest) GetStatusOk() (*BulkPowerFeedRequestStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *PowerFeedRequest) SetStatus(v BulkPowerFeedRequestStatus) {
	o.Status = &v
}
...
func (o *PowerFeedRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
