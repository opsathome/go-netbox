...
func (o *VirtualMachineWithConfigContext) GetVirtualMachineType() BriefVirtualMachineType {
...
func (o *VirtualMachineWithConfigContext) GetVirtualMachineTypeOk() (*BriefVirtualMachineType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VirtualMachineWithConfigContext) HasVirtualMachineType() bool {
...
func (o *VirtualMachineWithConfigContext) SetVirtualMachineType(v BriefVirtualMachineType) {
	o.VirtualMachineType.Set(&v)
}

// SetVirtualMachineTypeNil sets the value for VirtualMachineType to be an explicit nil
func (o *VirtualMachineWithConfigContext) SetVirtualMachineTypeNil() {
...
func (o *VirtualMachineWithConfigContext) UnsetVirtualMachineType() {
...
func (o *VirtualMachineWithConfigContext) GetStartOnBoot() VirtualMachineWithConfigContextStartOnBoot {
	if o == nil || IsNil(o.StartOnBoot) {
		var ret VirtualMachineWithConfigContextStartOnBoot
		return ret
	}
...
// SetStartOnBoot gets a reference to the given VirtualMachineWithConfigContextStartOnBoot and assigns it to the StartOnBoot field.
...
func (o *VirtualMachineWithConfigContext) SetOwnerNil() {
	o.Owner.Set(nil)
}
