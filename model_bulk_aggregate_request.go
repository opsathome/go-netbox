...
// checks if the BulkAggregateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkAggregateRequest{}

// BulkAggregateRequest Base serializer class for models inheriting from PrimaryModel.
type BulkAggregateRequest struct {
	Id                   int32                         `json:"id"`
...
type _BulkAggregateRequest BulkAggregateRequest
...
func (o *BulkAggregateRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkAggregateRequest) SetDateAddedNil() {
	o.DateAdded.Set(nil)
}
...
func (o *BulkAggregateRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkAggregateRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkAggregateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkAggregateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkAggregateRequest := _BulkAggregateRequest{}

	err = json.Unmarshal(data, &varBulkAggregateRequest)

	if err != nil {
		return err
	}

	*o = BulkAggregateRequest(varBulkAggregateRequest)
...
type NullableBulkAggregateRequest struct {
	value *BulkAggregateRequest
	isSet bool
}

func (v NullableBulkAggregateRequest) Get() *BulkAggregateRequest {
	return v.value
}

func (v *NullableBulkAggregateRequest) Set(val *BulkAggregateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkAggregateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkAggregateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkAggregateRequest(val *BulkAggregateRequest) *NullableBulkAggregateRequest {
	return &NullableBulkAggregateRequest{value: val, isSet: true}
}

func (v NullableBulkAggregateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkAggregateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
