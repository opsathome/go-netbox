...
// checks if the BulkRegionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkRegionRequest{}

// BulkRegionRequest Base serializer class for models inheriting from NestedGroupModel.
type BulkRegionRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkRegionRequest BulkRegionRequest
...
func (o *BulkRegionRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkRegionRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkRegionRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkRegionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkRegionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkRegionRequest := _BulkRegionRequest{}

	err = json.Unmarshal(data, &varBulkRegionRequest)

	if err != nil {
		return err
	}

	*o = BulkRegionRequest(varBulkRegionRequest)
...
type NullableBulkRegionRequest struct {
	value *BulkRegionRequest
	isSet bool
}

func (v NullableBulkRegionRequest) Get() *BulkRegionRequest {
	return v.value
}

func (v *NullableBulkRegionRequest) Set(val *BulkRegionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkRegionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkRegionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkRegionRequest(val *BulkRegionRequest) *NullableBulkRegionRequest {
	return &NullableBulkRegionRequest{value: val, isSet: true}
}

func (v NullableBulkRegionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkRegionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
