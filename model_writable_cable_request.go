...
func (o *WritableCableRequest) SetBundleNil() {
	o.Bundle.Set(nil)
}
...
func (o *WritableCableRequest) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *WritableCableRequest) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *WritableCableRequest) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *WritableCableRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
