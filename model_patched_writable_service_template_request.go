...
// PatchedWritableServiceTemplateRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PatchedWritableServiceTemplateRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
