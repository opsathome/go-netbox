...
func (o *PatchedUserRequest) GetEmail() EmailAddress {
...
// and a boolean to check if the value has been set.
func (o *PatchedUserRequest) GetEmailOk() (*EmailAddress, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *PatchedUserRequest) SetEmail(v EmailAddress) {
	o.Email = &v
}
