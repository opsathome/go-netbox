...
// MACAddress Base serializer class for models inheriting from PrimaryModel.
...
func (o *MACAddress) GetOwner() BriefOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MACAddress) GetOwnerOk() (*BriefOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MACAddress) HasOwner() bool {
...
func (o *MACAddress) SetOwner(v BriefOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *MACAddress) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *MACAddress) UnsetOwner() {
	o.Owner.Unset()
}
