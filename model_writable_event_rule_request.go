...
func NewWritableEventRuleRequest(objectTypes []string, name string, eventTypes []BulkEventRuleRequestEventTypesInner, actionObjectType string) *WritableEventRuleRequest {
...
func (o *WritableEventRuleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
