...
// PatchedProviderRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PatchedProviderRequest) GetOwner() ASNRangeRequestOwner {
...
func (o *PatchedProviderRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedProviderRequest) HasOwner() bool {
...
func (o *PatchedProviderRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *PatchedProviderRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *PatchedProviderRequest) UnsetOwner() {
	o.Owner.Unset()
}
