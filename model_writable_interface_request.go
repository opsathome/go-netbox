...
// WritableInterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func NewWritableInterfaceRequest(device BriefInterfaceRequestDevice, name string, type_ BulkInterfaceRequestType) *WritableInterfaceRequest {
...
func (o *WritableInterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
