...
// checks if the BulkProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkProviderRequest{}

// BulkProviderRequest Base serializer class for models inheriting from PrimaryModel.
...
type _BulkProviderRequest BulkProviderRequest
...
func (o *BulkProviderRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkProviderRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkProviderRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkProviderRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkProviderRequest := _BulkProviderRequest{}

	err = json.Unmarshal(data, &varBulkProviderRequest)

	if err != nil {
		return err
	}

	*o = BulkProviderRequest(varBulkProviderRequest)
...
type NullableBulkProviderRequest struct {
	value *BulkProviderRequest
	isSet bool
}

func (v NullableBulkProviderRequest) Get() *BulkProviderRequest {
	return v.value
}

func (v *NullableBulkProviderRequest) Set(val *BulkProviderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkProviderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkProviderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkProviderRequest(val *BulkProviderRequest) *NullableBulkProviderRequest {
	return &NullableBulkProviderRequest{value: val, isSet: true}
}

func (v NullableBulkProviderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkProviderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
