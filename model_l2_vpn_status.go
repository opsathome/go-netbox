...
type L2VPNStatus struct {
	Value                *BulkL2VPNRequestStatus `json:"value,omitempty"`
...
func (o *L2VPNStatus) GetValue() BulkL2VPNRequestStatus {
...
func (o *L2VPNStatus) GetValueOk() (*BulkL2VPNRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkL2VPNRequestStatus and assigns it to the Value field.
func (o *L2VPNStatus) SetValue(v BulkL2VPNRequestStatus) {
	o.Value = &v
}
