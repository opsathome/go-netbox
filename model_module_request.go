...
// ModuleRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewModuleRequest(device BriefInterfaceRequestDevice, moduleBay NestedModuleBayRequest, moduleType BulkModuleRequestModuleType) *ModuleRequest {
	this := ModuleRequest{}
	this.Device = device
...
func (o *ModuleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
