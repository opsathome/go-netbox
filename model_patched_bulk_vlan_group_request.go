...
// checks if the PatchedBulkVLANGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkVLANGroupRequest{}

// PatchedBulkVLANGroupRequest Base serializer class for models inheriting from OrganizationalModel.
type PatchedBulkVLANGroupRequest struct {
	Id                   int32                         `json:"id"`
...
type _PatchedBulkVLANGroupRequest PatchedBulkVLANGroupRequest
...
func NewPatchedBulkVLANGroupRequest(id int32) *PatchedBulkVLANGroupRequest {
	this := PatchedBulkVLANGroupRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkVLANGroupRequest) SetScopeTypeNil() {
	o.ScopeType.Set(nil)
}
...
func (o *PatchedBulkVLANGroupRequest) SetScopeIdNil() {
	o.ScopeId.Set(nil)
}
...
func (o *PatchedBulkVLANGroupRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkVLANGroupRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkVLANGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkVLANGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkVLANGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkVLANGroupRequest := _PatchedBulkVLANGroupRequest{}

	err = json.Unmarshal(data, &varPatchedBulkVLANGroupRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkVLANGroupRequest(varPatchedBulkVLANGroupRequest)
...
type NullablePatchedBulkVLANGroupRequest struct {
	value *PatchedBulkVLANGroupRequest
	isSet bool
}

func (v NullablePatchedBulkVLANGroupRequest) Get() *PatchedBulkVLANGroupRequest {
	return v.value
}

func (v *NullablePatchedBulkVLANGroupRequest) Set(val *PatchedBulkVLANGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkVLANGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkVLANGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkVLANGroupRequest(val *PatchedBulkVLANGroupRequest) *NullablePatchedBulkVLANGroupRequest {
	return &NullablePatchedBulkVLANGroupRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkVLANGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkVLANGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
