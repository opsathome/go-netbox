...
type InterfaceType struct {
	Value                *BulkInterfaceRequestType `json:"value,omitempty"`
...
func (o *InterfaceType) GetValue() BulkInterfaceRequestType {
...
func (o *InterfaceType) GetValueOk() (*BulkInterfaceRequestType, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkInterfaceRequestType and assigns it to the Value field.
func (o *InterfaceType) SetValue(v BulkInterfaceRequestType) {
	o.Value = &v
}
