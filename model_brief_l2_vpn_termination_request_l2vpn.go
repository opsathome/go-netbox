...
func (dst *BriefL2VPNTerminationRequestL2vpn) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(BriefL2VPNTerminationRequestL2vpn): %v", err)
		} else {
...
func (obj BriefL2VPNTerminationRequestL2vpn) GetActualInstanceValue() interface{} {
	if obj.BriefL2VPNRequest != nil {
		return *obj.BriefL2VPNRequest
	}
