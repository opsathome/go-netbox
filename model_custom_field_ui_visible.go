...
type CustomFieldUiVisible struct {
	Value                *BulkCustomFieldRequestUiVisible `json:"value,omitempty"`
...
func (o *CustomFieldUiVisible) GetValue() BulkCustomFieldRequestUiVisible {
...
func (o *CustomFieldUiVisible) GetValueOk() (*BulkCustomFieldRequestUiVisible, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkCustomFieldRequestUiVisible and assigns it to the Value field.
func (o *CustomFieldUiVisible) SetValue(v BulkCustomFieldRequestUiVisible) {
	o.Value = &v
}
