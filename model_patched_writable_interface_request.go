...
// PatchedWritableInterfaceRequest Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *PatchedWritableInterfaceRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
