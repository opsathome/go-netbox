...
// checks if the PatchedBulkManufacturerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkManufacturerRequest{}

// PatchedBulkManufacturerRequest Base serializer class for models inheriting from OrganizationalModel.
type PatchedBulkManufacturerRequest struct {
	Id                   int32                        `json:"id"`
...
type _PatchedBulkManufacturerRequest PatchedBulkManufacturerRequest
...
func NewPatchedBulkManufacturerRequest(id int32) *PatchedBulkManufacturerRequest {
	this := PatchedBulkManufacturerRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkManufacturerRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkManufacturerRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkManufacturerRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkManufacturerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkManufacturerRequest := _PatchedBulkManufacturerRequest{}

	err = json.Unmarshal(data, &varPatchedBulkManufacturerRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkManufacturerRequest(varPatchedBulkManufacturerRequest)
...
type NullablePatchedBulkManufacturerRequest struct {
	value *PatchedBulkManufacturerRequest
	isSet bool
}

func (v NullablePatchedBulkManufacturerRequest) Get() *PatchedBulkManufacturerRequest {
	return v.value
}

func (v *NullablePatchedBulkManufacturerRequest) Set(val *PatchedBulkManufacturerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkManufacturerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkManufacturerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkManufacturerRequest(val *PatchedBulkManufacturerRequest) *NullablePatchedBulkManufacturerRequest {
	return &NullablePatchedBulkManufacturerRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkManufacturerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkManufacturerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
