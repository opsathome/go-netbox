...
// checks if the BulkTenantRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkTenantRequest{}

// BulkTenantRequest Base serializer class for models inheriting from PrimaryModel.
...
type _BulkTenantRequest BulkTenantRequest
...
func (o *BulkTenantRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *BulkTenantRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkTenantRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkTenantRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkTenantRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkTenantRequest := _BulkTenantRequest{}

	err = json.Unmarshal(data, &varBulkTenantRequest)

	if err != nil {
		return err
	}

	*o = BulkTenantRequest(varBulkTenantRequest)
...
type NullableBulkTenantRequest struct {
	value *BulkTenantRequest
	isSet bool
}

func (v NullableBulkTenantRequest) Get() *BulkTenantRequest {
	return v.value
}

func (v *NullableBulkTenantRequest) Set(val *BulkTenantRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkTenantRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkTenantRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkTenantRequest(val *BulkTenantRequest) *NullableBulkTenantRequest {
	return &NullableBulkTenantRequest{value: val, isSet: true}
}

func (v NullableBulkTenantRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkTenantRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
