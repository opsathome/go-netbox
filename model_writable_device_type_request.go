...
// WritableDeviceTypeRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *WritableDeviceTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *WritableDeviceTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableDeviceTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
...
func (o *WritableDeviceTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
