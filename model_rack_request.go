...
// RackRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewRackRequest(name string, site BulkDeviceWithConfigContextRequestSite) *RackRequest {
	this := RackRequest{}
	this.Name = name
	this.Site = site
	return &this
...
func (o *RackRequest) GetSite() BulkDeviceWithConfigContextRequestSite {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RackRequest) GetSiteOk() (*BulkDeviceWithConfigContextRequestSite, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Site, true
...
func (o *RackRequest) SetSite(v BulkDeviceWithConfigContextRequestSite) {
	o.Site = v
}

// GetLocation returns the Location field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RackRequest) GetLocation() BulkDeviceWithConfigContextRequestLocation {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RackRequest) GetLocationOk() (*BulkDeviceWithConfigContextRequestLocation, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RackRequest) SetLocation(v BulkDeviceWithConfigContextRequestLocation) {
	o.Location.Set(&v)
}
...
func (o *RackRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *RackRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
