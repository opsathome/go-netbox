...
func (o *WritableJournalEntryRequest) GetKind() BulkJournalEntryRequestKind {
...
// and a boolean to check if the value has been set.
func (o *WritableJournalEntryRequest) GetKindOk() (*BulkJournalEntryRequestKind, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
func (o *WritableJournalEntryRequest) SetKind(v BulkJournalEntryRequestKind) {
	o.Kind = &v
}
