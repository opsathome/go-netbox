...
// checks if the BulkContactRoleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkContactRoleRequest{}

// BulkContactRoleRequest Base serializer class for models inheriting from OrganizationalModel.
type BulkContactRoleRequest struct {
	Id                   int32                        `json:"id"`
...
type _BulkContactRoleRequest BulkContactRoleRequest
...
func (o *BulkContactRoleRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkContactRoleRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkContactRoleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkContactRoleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkContactRoleRequest := _BulkContactRoleRequest{}

	err = json.Unmarshal(data, &varBulkContactRoleRequest)

	if err != nil {
		return err
	}

	*o = BulkContactRoleRequest(varBulkContactRoleRequest)
...
type NullableBulkContactRoleRequest struct {
	value *BulkContactRoleRequest
	isSet bool
}

func (v NullableBulkContactRoleRequest) Get() *BulkContactRoleRequest {
	return v.value
}

func (v *NullableBulkContactRoleRequest) Set(val *BulkContactRoleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkContactRoleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkContactRoleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkContactRoleRequest(val *BulkContactRoleRequest) *NullableBulkContactRoleRequest {
	return &NullableBulkContactRoleRequest{value: val, isSet: true}
}

func (v NullableBulkContactRoleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkContactRoleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
