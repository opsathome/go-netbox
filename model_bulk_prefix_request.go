...
// checks if the BulkPrefixRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkPrefixRequest{}

// BulkPrefixRequest Base serializer class for models inheriting from PrimaryModel.
type BulkPrefixRequest struct {
	Id        int32                                    `json:"id"`
...
type _BulkPrefixRequest BulkPrefixRequest
...
func (o *BulkPrefixRequest) SetVrfNil() {
	o.Vrf.Set(nil)
}
...
func (o *BulkPrefixRequest) SetScopeTypeNil() {
	o.ScopeType.Set(nil)
}
...
func (o *BulkPrefixRequest) SetScopeIdNil() {
	o.ScopeId.Set(nil)
}
...
func (o *BulkPrefixRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkPrefixRequest) SetVlanNil() {
	o.Vlan.Set(nil)
}
...
func (o *BulkPrefixRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *BulkPrefixRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o BulkPrefixRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkPrefixRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkPrefixRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkPrefixRequest := _BulkPrefixRequest{}

	err = json.Unmarshal(data, &varBulkPrefixRequest)

	if err != nil {
		return err
	}

	*o = BulkPrefixRequest(varBulkPrefixRequest)
...
type NullableBulkPrefixRequest struct {
	value *BulkPrefixRequest
	isSet bool
}

func (v NullableBulkPrefixRequest) Get() *BulkPrefixRequest {
	return v.value
}

func (v *NullableBulkPrefixRequest) Set(val *BulkPrefixRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkPrefixRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkPrefixRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkPrefixRequest(val *BulkPrefixRequest) *NullableBulkPrefixRequest {
	return &NullableBulkPrefixRequest{value: val, isSet: true}
}

func (v NullableBulkPrefixRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkPrefixRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
