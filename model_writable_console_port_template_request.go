...
func (o *WritableConsolePortTemplateRequest) GetDeviceType() BulkConsolePortTemplateRequestDeviceType {
...
func (o *WritableConsolePortTemplateRequest) GetDeviceTypeOk() (*BulkConsolePortTemplateRequestDeviceType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableConsolePortTemplateRequest) SetDeviceType(v BulkConsolePortTemplateRequestDeviceType) {
	o.DeviceType.Set(&v)
}
...
func (o *WritableConsolePortTemplateRequest) GetModuleType() BulkConsolePortTemplateRequestModuleType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableConsolePortTemplateRequest) GetModuleTypeOk() (*BulkConsolePortTemplateRequestModuleType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableConsolePortTemplateRequest) SetModuleType(v BulkConsolePortTemplateRequestModuleType) {
	o.ModuleType.Set(&v)
}
