...
func NewEventRule(id int32, url string, display string, objectTypes []string, name string, eventTypes []BulkEventRuleRequestEventTypesInner, actionType EventRuleActionType, actionObjectType string) *EventRule {
	this := EventRule{}
	this.Id = id
	this.Url = url
...
// GetActionObject returns the ActionObject field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetActionObjectOk returns a tuple with the ActionObject field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EventRule) GetActionObjectOk() (*interface{}, bool) {
	if o == nil || IsNil(o.ActionObject) {
		return nil, false
	}
...
// SetActionObject gets a reference to the given interface{} and assigns it to the ActionObject field.
