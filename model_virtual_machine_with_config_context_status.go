...
type VirtualMachineWithConfigContextStatus struct {
	Value                *BulkVirtualMachineWithConfigContextRequestStatus `json:"value,omitempty"`
...
func (o *VirtualMachineWithConfigContextStatus) GetValue() BulkVirtualMachineWithConfigContextRequestStatus {
...
func (o *VirtualMachineWithConfigContextStatus) GetValueOk() (*BulkVirtualMachineWithConfigContextRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkVirtualMachineWithConfigContextRequestStatus and assigns it to the Value field.
func (o *VirtualMachineWithConfigContextStatus) SetValue(v BulkVirtualMachineWithConfigContextRequestStatus) {
	o.Value = &v
}
