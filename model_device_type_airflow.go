...
type DeviceTypeAirflow struct {
	Value                *BulkDeviceWithConfigContextRequestAirflow `json:"value,omitempty"`
...
func (o *DeviceTypeAirflow) GetValue() BulkDeviceWithConfigContextRequestAirflow {
...
func (o *DeviceTypeAirflow) GetValueOk() (*BulkDeviceWithConfigContextRequestAirflow, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkDeviceWithConfigContextRequestAirflow and assigns it to the Value field.
func (o *DeviceTypeAirflow) SetValue(v BulkDeviceWithConfigContextRequestAirflow) {
	o.Value = &v
}
