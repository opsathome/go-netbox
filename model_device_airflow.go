...
func (o *DeviceAirflow) GetValue() BulkDeviceWithConfigContextRequestAirflow {
...
func (o *DeviceAirflow) GetValueOk() (*BulkDeviceWithConfigContextRequestAirflow, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *DeviceAirflow) SetValue(v BulkDeviceWithConfigContextRequestAirflow) {
	o.Value = &v
}
