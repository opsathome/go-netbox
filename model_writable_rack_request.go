...
// WritableRackRequest Base serializer class for models inheriting from PrimaryModel.
...
func NewWritableRackRequest(name string, site BulkDeviceWithConfigContextRequestSite) *WritableRackRequest {
...
func (o *WritableRackRequest) GetSite() BulkDeviceWithConfigContextRequestSite {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WritableRackRequest) GetSiteOk() (*BulkDeviceWithConfigContextRequestSite, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Site, true
...
func (o *WritableRackRequest) SetSite(v BulkDeviceWithConfigContextRequestSite) {
	o.Site = v
}

// GetLocation returns the Location field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WritableRackRequest) GetLocation() BulkDeviceWithConfigContextRequestLocation {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableRackRequest) GetLocationOk() (*BulkDeviceWithConfigContextRequestLocation, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WritableRackRequest) SetLocation(v BulkDeviceWithConfigContextRequestLocation) {
	o.Location.Set(&v)
}
...
func (o *WritableRackRequest) SetGroupNil() {
	o.Group.Set(nil)
}
...
func (o *WritableRackRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
