...
type IPAddressStatus struct {
	Value                *BulkIPAddressRequestStatus `json:"value,omitempty"`
...
func (o *IPAddressStatus) GetValue() BulkIPAddressRequestStatus {
...
func (o *IPAddressStatus) GetValueOk() (*BulkIPAddressRequestStatus, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
// SetValue gets a reference to the given BulkIPAddressRequestStatus and assigns it to the Value field.
func (o *IPAddressStatus) SetValue(v BulkIPAddressRequestStatus) {
	o.Value = &v
}
