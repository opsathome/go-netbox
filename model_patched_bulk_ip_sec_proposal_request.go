...
// checks if the PatchedBulkIPSecProposalRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkIPSecProposalRequest{}

// PatchedBulkIPSecProposalRequest Base serializer class for models inheriting from PrimaryModel.
type PatchedBulkIPSecProposalRequest struct {
	Id                      int32                                          `json:"id"`
...
type _PatchedBulkIPSecProposalRequest PatchedBulkIPSecProposalRequest
...
func NewPatchedBulkIPSecProposalRequest(id int32) *PatchedBulkIPSecProposalRequest {
	this := PatchedBulkIPSecProposalRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkIPSecProposalRequest) SetSaLifetimeSecondsNil() {
...
func (o *PatchedBulkIPSecProposalRequest) SetSaLifetimeDataNil() {
...
func (o *PatchedBulkIPSecProposalRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o PatchedBulkIPSecProposalRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkIPSecProposalRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkIPSecProposalRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkIPSecProposalRequest := _PatchedBulkIPSecProposalRequest{}

	err = json.Unmarshal(data, &varPatchedBulkIPSecProposalRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkIPSecProposalRequest(varPatchedBulkIPSecProposalRequest)
...
type NullablePatchedBulkIPSecProposalRequest struct {
	value *PatchedBulkIPSecProposalRequest
	isSet bool
}

func (v NullablePatchedBulkIPSecProposalRequest) Get() *PatchedBulkIPSecProposalRequest {
	return v.value
}

func (v *NullablePatchedBulkIPSecProposalRequest) Set(val *PatchedBulkIPSecProposalRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkIPSecProposalRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkIPSecProposalRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkIPSecProposalRequest(val *PatchedBulkIPSecProposalRequest) *NullablePatchedBulkIPSecProposalRequest {
	return &NullablePatchedBulkIPSecProposalRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkIPSecProposalRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkIPSecProposalRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
