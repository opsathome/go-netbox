...
// Manufacturer Base serializer class for models inheriting from OrganizationalModel.
type Manufacturer struct {
	...
	ModuletypeCount      int64                  `json:"moduletype_count"`
...
func (o *Manufacturer) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
// GetModuletypeCount returns the ModuletypeCount field value
...
// GetModuletypeCountOk returns a tuple with the ModuletypeCount field value
// and a boolean to check if the value has been set.
...
// SetModuletypeCount sets field value
...
func (o Manufacturer) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["moduletype_count"] = o.ModuletypeCount
...
func (o *Manufacturer) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Manufacturer(varManufacturer)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "moduletype_count")
