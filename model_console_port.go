...
// ConsolePort Adds an `owner` field for models which have a ForeignKey to users.Owner.
...
func (o *ConsolePort) GetCableEnd() CircuitTerminationCableEnd {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsolePort) GetCableEndOk() (*CircuitTerminationCableEnd, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ConsolePort) SetOwnerNil() {
	o.Owner.Set(nil)
}
