...
// BriefModuleType Base serializer class for models inheriting from PrimaryModel.
...
// GetModuleCount returns the ModuleCount field value
func (o *BriefModuleType) GetModuleCount() int32 {
	...
	return o.ModuleCount
}

// GetModuleCountOk returns a tuple with the ModuleCount field value
// and a boolean to check if the value has been set.
func (o *BriefModuleType) GetModuleCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ModuleCount, true
}

// SetModuleCount sets field value
...
func (o BriefModuleType) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["module_count"] = o.ModuleCount
...
func (o *BriefModuleType) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BriefModuleType(varBriefModuleType)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "module_count")
