...
// CircuitType Base serializer class for models inheriting from OrganizationalModel.
...
func (o *CircuitType) GetColor() BulkCableRequestColor {
...
// and a boolean to check if the value has been set.
func (o *CircuitType) GetColorOk() (*BulkCableRequestColor, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *CircuitType) SetColor(v BulkCableRequestColor) {
	o.Color = &v
}
...
func (o *CircuitType) SetOwnerNil() {
	o.Owner.Set(nil)
}
