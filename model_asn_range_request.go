...
// ASNRangeRequest Base serializer class for models inheriting from OrganizationalModel.
...
func (o *ASNRangeRequest) GetOwner() ASNRangeRequestOwner {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ASNRangeRequest) GetOwnerOk() (*ASNRangeRequestOwner, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ASNRangeRequest) HasOwner() bool {
...
func (o *ASNRangeRequest) SetOwner(v ASNRangeRequestOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *ASNRangeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}

// UnsetOwner ensures that no value is present for Owner, not even an explicit nil
func (o *ASNRangeRequest) UnsetOwner() {
	o.Owner.Unset()
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *ASNRangeRequest) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *ASNRangeRequest) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *ASNRangeRequest) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
...
func (o *ASNRangeRequest) SetComments(v string) {
	o.Comments = &v
}
