...
// PatchedWritableDeviceTypeRequest Base serializer class for models inheriting from PrimaryModel.
...
func (o *PatchedWritableDeviceTypeRequest) GetDefaultPlatform() BulkDeviceTypeRequestDefaultPlatform {
...
func (o *PatchedWritableDeviceTypeRequest) GetDefaultPlatformOk() (*BulkDeviceTypeRequestDefaultPlatform, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedWritableDeviceTypeRequest) SetDefaultPlatform(v BulkDeviceTypeRequestDefaultPlatform) {
...
func (o *PatchedWritableDeviceTypeRequest) SetOwnerNil() {
	o.Owner.Set(nil)
}
